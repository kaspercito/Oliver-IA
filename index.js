...
const preguntas = [
    ...
    '¿Cuál es el mejor gol que viste en tu vida?',
    '¿Qué hacés cuando se corta la luz y no hay wifi?',
    '¿Cuál es tu helado favorito pa’ romper la dieta?',
    '¿Qué harías si te nombran jefe de tu barrio por un día?',
    '¿Cuál es la excusa más trucha que diste pa’ zafar de algo?',
    '¿Qué personaje de dibujo animado serías y por qué?',
    '¿Cuál es el mejor recuerdo de un verano que tuviste?',
    '¿Qué harías si te cruzás a tu ídolo en la calle?',
    '¿Cuál es tu mate perfecto: dulce, amargo o cómo?',
    '¿Qué canción cantarías a gritos en un karaoke?',
    '¿Cuál es el regalo más raro que te dieron?',
    '¿Qué harías si te toca ser DJ en una fiesta?',
    '¿Cuál es el lugar de Argentina que siempre quisiste visitar?',
    '¿Qué hacés cuando te piden "un favorcito" pero sabés que es un quilombo?',
    '¿Cuál es el peor apodo que le pusiste a alguien?',
    '¿Qué harías si te dejan a cargo de un equipo de fútbol?',
    '¿Cuál es tu truco pa’ sobrevivir un lunes?',
    '¿Qué comida de tu infancia extrañás posta?',
    '¿Qué harías si te dan un día pa’ gastar todo lo que quieras sin límite?',
    '¿Cuál es el meme que más te hizo reír últimamente?',
    '¿Qué harías si te toca ser el organizador del próximo carnaval?',
    '¿Cuál es tu técnica infalible pa’ ganar al truco?',
    '¿Qué hacés cuando te das cuenta que te olvidaste algo importante?',
    '¿Cuál es el mejor piropo que escuchaste o dijiste?',
    '¿Qué harías si te toca dirigir una peli argentina?',
    '¿Cuál es tu bebida favorita pa’ un día de calor?',
    '¿Qué hacés si te quedás encerrado en un ascensor con un desconocido?',
    '¿Cuál es el peor corte de pelo que te hiciste?',
    '¿Qué harías si te dan una máquina pa’ leer el futuro?',
    '¿Cuál es tu recuerdo más loco de una fiesta?',
    '¿Qué hacés cuando te piden "cantá algo" pero no tenés ganas?',
    '¿Cuál es el juego de la infancia que volverías a jugar hoy?',
    '¿Qué harías si te toca ser el rey o reina del mate por un día?',
    '¿Cuál es el mejor insulto creativo que se te ocurrió?',
    '¿Qué hacés cuando el bondi no pasa y llegás tarde?',
    '¿Cuál es tu plan perfecto pa’ un feriado largo?',
    '¿Qué harías si te dan un micrófono en un escenario sin aviso?',
    '¿Cuál es el olor que más te recuerda a tu casa?',
    '¿Qué hacés si te piden plata prestada pero sabés que no te la devuelven?',
    '¿Cuál es el mejor partido de fútbol que viste en vivo o por tele?',
    '¿Qué harías si te toca ser el anfitrión de un asado pa’ 20 personas?',
    '¿Cuál es tu estrategia pa’ no pelearte en una discusión boluda?',
    '¿Qué hacés cuando te das cuenta que compraste algo que no necesitás?',
    '¿Cuál es el mejor viaje corto que hiciste con amigos o familia?',
    '¿Qué harías si te toca elegir la música pa’ un viaje largo en auto?',
    '¿Cuál es tu recuerdo favorito de la primaria o secundaria?',
    '¿Qué hacés si te piden que cocines pero no tenés ganas?',
    '¿Cuál es el mejor chiste corto que sabés pa’ romper el hielo?',
    '¿Qué harías si te dan superpoderes pero solo por 24 horas?',
    '¿Cuál es el lugar más loco donde te perdiste?',
    '¿Qué hacés cuando te dicen "nos vemos en 5" pero pasan 20 minutos?',
    '¿Cuál es tu técnica pa’ no gastar de más en una salida?',
    '¿Qué harías si te toca ser el árbitro de un picadito?',
    '¿Cuál es el mejor sánguche que te preparaste o comiste?',
    '¿Qué hacés si te quedás sin batería en el medio de la nada?',
    '¿Cuál es tu recuerdo más vergonzoso pero gracioso?',
    '¿Qué harías si te toca armar un equipo pa’ un torneo de algo?',
    '¿Cuál es el mejor consejo que te dieron pa’ la vida?',
    '¿Qué hacés cuando te piden "explicame rápido" pero es re complicado?',
    '¿Cuál es tu golosina favorita de la infancia?',
    '¿Qué harías si te toca ser guía turístico por un día?',
    '¿Cuál es el peor error que cometiste cocinando?',
    '¿Qué hacés si te invitan a un lugar pero no querés ir?',
    '¿Cuál es tu recuerdo favorito de un cumpleaños?',
    '¿Qué harías si te dan una semana pa’ hacer lo que quieras sin laburo?',
    '¿Cuál es el mejor invento pa’ vaguear que se te ocurre?',
    '¿Qué hacés cuando te dicen "vos manejá" pero no tenés ganas?',
    '¿Cuál es tu técnica pa’ no quedarte sin tema en una charla?',
    '¿Qué harías si te toca ser el que corta la torta en una fiesta?',
    '¿Cuál es el mejor apodo que viste en un grupo de amigos?',
    '¿Qué hacés si te piden "hacé un chiste" pero no se te ocurre nada?',
    '¿Cuál es tu recuerdo más loco de un viaje en bondi o tren?',
    '¿Qué harías si te toca elegir el destino de las próximas vacaciones?',
    '¿Cuál es el mejor truco casero que sabés pa’ arreglar algo?',
    '¿Qué hacés cuando te dicen "es cerca" pero terminás caminando un montón?',
    '¿Cuál es tu canción favorita pa’ poner en un asado?',
    '¿Qué harías si te toca ser el fotógrafo oficial de un evento?',
    '¿Cuál es el peor regalo que diste y te arrepentiste?',
    '¿Qué hacés si te piden "contá algo interesante" y no tenés nada?',
    '¿Cuál es tu recuerdo más loco de un día de calor?',
    '¿Qué harías si te dan un día pa’ mandar en tu ciudad?',
    '¿Cuál es el mejor momento pa’ tomar mate según vos?',
    '¿Qué hacés cuando te dicen "vos elegí la peli" pero no te decidís?',
    '¿Cuál es tu técnica pa’ no aburrirte en una fila eterna?',
    '¿Qué harías si te toca ser el que arma el picadito del finde?',
    '¿Cuál es el mejor piropo que te salió sin pensar?',
    '¿Qué hacés si te piden "bailá algo" pero no sabés bailar?',
    '¿Cuál es tu recuerdo favorito de un día con amigos?',
    '¿Qué harías si te toca ser el que prende el fuego del asado?',
    '¿Cuál es el mejor juego de mesa que jugaste ever?',
    '¿Qué hacés cuando te dicen "es rapidito" pero termina siendo eterno?',
    '¿Cuál es tu técnica pa’ no quemarte con el sol en verano?',
    '¿Qué harías si te dan un día pa’ gastar en tecnología sin límite?',
    '¿Cuál es el mejor recuerdo de una salida nocturna?',
    '¿Qué hacés si te piden "hacé una lista" pero no tenés ganas?',
    '¿Cuál es tu truco pa’ levantarte de buen humor?',
    '¿Qué harías si te toca organizar un torneo de Play?',
    '¿Cuál es el mejor sánguche de miga que probaste?',
    '¿Qué hacés cuando te dicen "vos pagá y después vemos"?',
    '¿Cuál es tu recuerdo más loco de un feriado?',
    '¿Qué harías si te toca ser el que pone la playlist del viaje?',
    '¿Cuál es el mejor consejo que diste a alguien?',
    '¿Qué hacés si te piden "explicá esto" pero no entendés nada?',
    '¿Cuál es tu técnica pa’ no pelear por boludeces?',
    '¿Qué harías si te toca ser el que reparte la pizza?',
    '¿Cuál es el mejor momento del día pa’ tomar una birra?',
    '¿Qué hacés cuando te dicen "llegamos en 10" pero tardan 40?',
    '¿Cuál es tu recuerdo más loco de un día de frío?',
    '¿Qué harías si te dan un día pa’ ser invisible?',
    '¿Cuál es el mejor chiste que te contaron en una sobremesa?'
];
