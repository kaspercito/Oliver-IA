...
const adivinanzas = [
  {
    pregunta:
      "Soy redondo, soy de cuero, en la cancha soy el rey, los pibes me patean con ganas, ¿qué soy, che?",
    respuesta: "pelota",
  },
  {
    pregunta:
      "Estoy en el mate, estoy en el té, sin mí no hay gusto, ¿qué soy, qué sé?",
    respuesta: "azúcar",
  },
  {
    pregunta:
      "Soy blanco y negro, camino tranqui por el campo, no soy caballo ni vaca, pero igual me quieren mucho, ¿qué soy, loco?",
    respuesta: "pingüino",
  },
  {
    pregunta:
      "En la parrilla soy la estrella, me comen con chimichurri, soy jugosa y re sabrosa, ¿qué soy, posta?",
    respuesta: "asado",
  },
  {
    pregunta:
      "Me toman en la plaza, soy verde y amargo, con agua caliente me quieren, ¿qué soy, amigo?",
    respuesta: "mate",
  },
  {
    pregunta:
      "Soy un bicho que vuela, hago ruido en la noche, los pibes me cazan con linterna, ¿qué soy, che?",
    respuesta: "cucaracha",
  },
  {
    pregunta:
      "Estoy en el cielo, brillo de día, no soy estrella ni luna, pero caliento el asado, ¿qué soy, loco?",
    respuesta: "sol",
  },
  {
    pregunta:
      "Soy chiquito, soy de papel, me usás pa’ pagar el bondi, ¿qué soy, loco?",
    respuesta: "boleto",
  },
  {
    pregunta:
      "Me ponés en la cabeza, me querés cuando llueve, si me perdés te mojás, ¿qué soy, che?",
    respuesta: "paraguas",
  },
  {
  ...
  {
    pregunta:
      "Me subís y me bajás, te llevo a tu piso, en el edificio vivo, ¿qué soy, posta?",
    respuesta: "ascensor",
  },
  {
    pregunta:
      "Soy largo, soy verde, en el río me encontrás, no soy pez ni rana, ¿qué soy, loco?",
    respuesta: "yacaré",
  },
  {
    pregunta:
      "Me usás pa’ escribir, tengo tinta adentro, si me apretás mucho me rompo, ¿qué soy, che?",
    respuesta: "birome",
  },
  {
    pregunta:
      "Soy redonda, soy finita, me comés con la pizza, ¿qué soy, amigo?",
    respuesta: "aceituna",
  },
  {
    pregunta:
      "Me gritás en la cancha, me querés cuando ganás, soy alegría pura, ¿qué soy, posta?",
    respuesta: "gol",
  },
  {
    pregunta:
      "Soy chiquita, soy dulce, en la panadería me comprás, ¿qué soy, loco?",
    respuesta: "factura",
  },
  {
    pregunta:
      "Me ponés en los pies, me atás con cordones, si corro mucho me gastás, ¿qué soy, che?",
    respuesta: "zapatilla",
  },
  {
    pregunta:
      "Soy marrón, soy calentito, en el desayuno me tomás, ¿qué soy, amigo?",
    respuesta: "café",
  },
  {
    pregunta:
      "Me usás pa’ cortar, tengo filo zarpado, en la cocina soy el rey, ¿qué soy, posta?",
    respuesta: "cuchillo",
  },
  {
    pregunta:
      "Soy alto, soy verde, en el campo me ves, no soy árbol ni arbusto, ¿qué soy, loco?",
    respuesta: "maíz",
  },
  {
    pregunta:
      "Me escuchás en la radio, me bailás en la fiesta, soy puro ritmo, ¿qué soy, che?",
    respuesta: "música",
  },
  {
    pregunta:
      "Soy negro, soy brillante, me usás pa’ ver tele, si me perdés te enojás, ¿qué soy, amigo?",
    respuesta: "control",
  },
  {
    pregunta:
      "Me comés en el cine, soy salado y crujiente, si me tirás al piso te retan, ¿qué soy, posta?",
    respuesta: "pochoclo",
  },
  {
    pregunta:
      "Soy rápido, soy ruidoso, en la calle me encontrás, no soy auto ni moto, ¿qué soy, loco?",
    respuesta: "colectivo",
  },
  {
    pregunta:
      "Me usás pa’ dormir, soy blandita y cómoda, en la cama estoy, ¿qué soy, che?",
    respuesta: "almohada",
  },
  {
    pregunta:
      "Soy blanco, soy líquido, me echás en el arroz, si me falta no hay comida, ¿qué soy, amigo?",
    respuesta: "leche",
  },
  {
    pregunta:
      "Me colgás en la pared, te digo la hora, si me atraso te enojás, ¿qué soy, posta?",
    respuesta: "reloj",
  },
  {
  ...
  {
    pregunta:
      "Me usás pa’ lavar, hago espuma zarpada, en el baño estoy, ¿qué soy, che?",
    respuesta: "jabón",
  },
  {
    pregunta:
      "Soy grande, soy de madera, te sentás con la familia, ¿qué soy, amigo?",
    respuesta: "mesa",
  },
  {
    pregunta:
      "Me ponés en la oreja, me hablás bajito, si me cortás no escuchás, ¿qué soy, posta?",
    respuesta: "teléfono",
  },
  {
  ...
  {
    pregunta:
      "Me usás pa’ peinarte, tengo dientes pero no muerdo, ¿qué soy, che?",
    respuesta: "peine",
  },
  {
    pregunta:
      "Soy rojo, soy picante, me ponés en la empanada, ¿qué soy, amigo?",
    respuesta: "ají",
  },
  {
    pregunta:
      "Me subís pa’ viajar, tengo alas pero no soy pájaro, ¿qué soy, posta?",
    respuesta: "avión",
  },
  {
    pregunta:
      "Soy negro, soy caliente, me tomás en la oficina, ¿qué soy, loco?",
    respuesta: "té",
  },
  {
  ...
  {
    pregunta:
      "Me ponés en la espalda, llevo tus cosas al colegio, ¿qué soy, posta?",
    respuesta: "mochila",
  },
  {
  ...
  {
    pregunta:
      "Me usás pa’ sentarte, tengo patas pero no camino, ¿qué soy, che?",
    respuesta: "silla",
  },
  {
  ...
  {
    pregunta:
      "Me mirás pa’ verte, si me rompés son siete años de yeta, ¿qué soy, posta?",
    respuesta: "espejo",
  },
  {
    pregunta:
      "Soy grande, soy frío, guardo la comida pa’ después, ¿qué soy, loco?",
    respuesta: "heladera",
  },
  {
    pregunta:
      "Me usás pa’ prender fuego, soy chiquito pero peligroso, ¿qué soy, che?",
    respuesta: "fósforo",
  },
  {
    pregunta:
      "Soy amarillo, soy ácido, me exprimís pa’l jugo, ¿qué soy, amigo?",
    respuesta: "limón",
  },
  {
  ...
  {
    pregunta:
      "Soy verde, soy crocante, me comés en la ensalada, ¿qué soy, loco?",
    respuesta: "lechuga",
  },
  {
  ...
  {
    pregunta:
      "Soy marrón, soy duro, me encontrás en el bosque, ¿qué soy, amigo?",
    respuesta: "tronco",
  },
  {
    pregunta:
      "Me escuchás en la tormenta, retumbo bien fuerte, ¿qué soy, posta?",
    respuesta: "trueno",
  },
  {
    pregunta:
      "Soy blanco, soy esponjoso, me comés con la sopa, ¿qué soy, loco?",
    respuesta: "pan",
  },
  {
  ...
  {
    pregunta:
      "Me usás pa’ barrer, tengo pelos pero no soy perro, ¿qué soy, che?",
    respuesta: "escoba",
  },
  {
  ...
  {
    pregunta:
      "Soy largo, soy amarillo, me comés en el verano, ¿qué soy, amigo?",
    respuesta: "choclo",
  },
  {
    pregunta:
      "Me subís pa’l balcón, tengo ruedas pero no soy auto, ¿qué soy, posta?",
    respuesta: "bicicleta",
  },
  {
  ...
  {
    pregunta:
      "Soy verde, soy brillante, me encontrás en el césped, ¿qué soy, amigo?",
    respuesta: "grillo",
  },
  {
  ...
  {
    pregunta:
      "Soy dulce, soy marrón, me derretís pa’l helado, ¿qué soy, amigo?",
    respuesta: "chocolate",
  },
  {
  ...
  {
    pregunta:
      "Soy chiquito, soy plateado, me usás pa’l cinturón, ¿qué soy, loco?",
    respuesta: "botón",
  },
  {
  ...
  {
    pregunta:
      "Soy naranja, soy jugosa, me comés en el desayuno, ¿qué soy, amigo?",
    respuesta: "naranja",
  },
  {
  ...
  {
    pregunta:
      "Soy blanco, soy caliente, me tomás en la merienda, ¿qué soy, loco?",
    respuesta: "leche",
  },
  {
  ...
  {
    pregunta:
      "Soy amarillo, soy brillante, me ves en la noche, ¿qué soy, amigo?",
    respuesta: "estrella",
  },
  {
  ...
  {
    pregunta:
      "Soy rojo, soy brillante, me encontrás en el árbol, ¿qué soy, amigo?",
    respuesta: "manzana",
  },
  {
  ...
  {
    pregunta:
      "Soy blanco, soy caliente, me comés en el invierno, ¿qué soy, amigo?",
    respuesta: "caldo",
  },
  {
...
const preguntasTriviaSinOpciones = {
  capitales: [
    ...
    {
      pregunta: "¿Cuál es la capital de Birmania (Myanmar)?",
      respuesta: "neipyido",
    },
    ...
    {
      pregunta: "¿Cuál es la capital de Brunéi?",
      respuesta: "bandar seri begawan",
    },
    ...
    {
      pregunta: "¿Cuál es la capital de Esuatini (Suazilandia)?",
      respuesta: "mbabane",
    }, // Nota: Lobamba es la capital legislativa, pero Mbabane es administrativa
    ...
    { pregunta: "¿Cuál es la capital de Guinea-Bisáu?", respuesta: "bisáu" },
    {
      ...
      respuesta: "malabo",
    }, // Nota: Ciudad de la Paz está en construcción, pero Malabo sigue siendo oficial
    ...
    {
      pregunta: "¿Cuál es la capital de República Centroafricana?",
      respuesta: "bangui",
    },
    { pregunta: "¿Cuál es la capital de República Checa?", respuesta: "praga" },
    {
      pregunta: "¿Cuál es la capital de República del Congo?",
      respuesta: "brazzaville",
    },
    {
      pregunta: "¿Cuál es la capital de República Democrática del Congo?",
      respuesta: "kinshasa",
    },
    {
      pregunta: "¿Cuál es la capital de República Dominicana?",
      respuesta: "santo domingo",
    },
  ...
  quimica: [
    ...
    {
      pregunta: "¿Qué gas tiene la fórmula CO2?",
      respuesta: "dióxido de carbono",
    },
    {
      pregunta: "¿Qué elemento es un metal líquido a temperatura ambiente?",
      respuesta: "mercurio",
    },
    ...
    {
      pregunta: "¿Qué compuesto es el peróxido de hidrógeno?",
      respuesta: "h2o2",
    },
    {
      pregunta: "¿Qué elemento tiene el símbolo 'Sr'?",
      respuesta: "estroncio",
    },
    ...
    {
      pregunta: "¿Qué compuesto es el bicarbonato de sodio?",
      respuesta: "nahco3",
    },
    ...
    {
      pregunta: "¿Qué elemento tiene el símbolo 'Sb'?",
      respuesta: "antimonio",
    },
    ...
    {
      pregunta: "¿Qué compuesto es el carbonato de calcio?",
      respuesta: "caco3",
    },
    ...
    {
      pregunta: "¿Qué elemento tiene el símbolo 'Dy'?",
      respuesta: "disprosio",
    },
    {
      pregunta: "¿Qué compuesto es el acetato de sodio?",
      respuesta: "ch3coona",
    },
    ...
    {
      pregunta: "¿Qué compuesto es el sulfato de magnesio?",
      respuesta: "mgso4",
    },
    ...
    {
      pregunta: "¿Qué compuesto es el nitrato de amonio?",
      respuesta: "nh4no3",
    },
    ...
    {
      pregunta: "¿Qué compuesto es el clorato de potasio?",
      respuesta: "kclo3",
    },
    { pregunta: "¿Qué elemento tiene el símbolo 'Ra'?", respuesta: "radio" },
    { pregunta: "¿Qué metal tiene el símbolo 'Hg'?", respuesta: "mercurio" },
    {
      pregunta: "¿Qué elemento tiene el símbolo 'Rf'?",
      respuesta: "rutherfordio",
    },
    {
      pregunta: "¿Qué compuesto es el fosfato de calcio?",
      respuesta: "ca3(po4)2",
    },
  ],
  fisica: [
    ...
    {
      pregunta: "¿Qué tipo de energía almacena un resorte comprimido?",
      respuesta: "energía elástica",
    },
    ...
    {
      pregunta: "¿Qué ley dice que la energía no se crea ni se destruye?",
    ...
    {
      pregunta: "¿Qué tipo de onda transporta el sonido?",
      respuesta: "longitudinal",
    },
    { pregunta: "¿Qué mide la unidad 'hertz'?", respuesta: "frecuencia" },
    {
      pregunta: "¿Qué fuerza mantiene a los planetas en órbita?",
      respuesta: "gravedad",
    },
    { pregunta: "¿Qué mide la unidad 'ohmio'?", respuesta: "resistencia" },
    {
      pregunta: "¿Qué fenómeno explica la curvatura de la luz por la gravedad?",
      respuesta: "relatividad general",
    },
    {
    ...
    {
      pregunta: "¿Qué mide la unidad 'amperio'?",
      respuesta: "corriente eléctrica",
    },
    {
      pregunta: "¿Qué instrumento mide la velocidad del viento?",
      respuesta: "anemómetro",
    },
    {
      pregunta:
        "¿Qué ley dice que a toda acción hay una reacción igual y opuesta?",
      respuesta: "tercera ley de newton",
    },
    {
      pregunta: "¿Qué mide la unidad 'candela'?",
      respuesta: "intensidad luminosa",
    },
    {
      pregunta: "¿Qué instrumento mide la humedad del aire?",
      respuesta: "higrómetro",
    },
    {
      pregunta: "¿Qué tipo de energía tiene un objeto en altura?",
      respuesta: "potencial",
    },
    {
      pregunta: "¿Qué ley dice que un objeto en reposo sigue en reposo?",
    ...
    {
      pregunta: "¿Qué instrumento mide la radiación?",
      respuesta: "contador geiger",
    },
    { pregunta: "¿Qué tipo de onda es la luz?", respuesta: "transversal" },
    { pregunta: "¿Qué mide la unidad 'pascal'?", respuesta: "presión" },
    {
      pregunta: "¿Quién descubrió la ley de la gravitación universal?",
      respuesta: "newton",
    },
    { pregunta: "¿Qué mide la unidad 'tesla'?", respuesta: "campo magnético" },
    {
      pregunta: "¿Qué fenómeno explica la dilatación del tiempo?",
      respuesta: "relatividad especial",
    },
    {
      pregunta: "¿Qué instrumento mide la distancia recorrida?",
      respuesta: "odómetro",
    },
    ...
    {
      pregunta: "¿Qué fenómeno explica la dispersión de la luz?",
    ...
    {
      pregunta: "¿Qué fenómeno explica el efecto Doppler?",
      respuesta: "cambio de frecuencia",
    },
    {
      pregunta: "¿Qué mide la unidad 'sievert'?",
      respuesta: "dosis de radiación",
    },
    {
      pregunta: "¿Qué instrumento mide la intensidad del sonido?",
      respuesta: "sonómetro",
    },
    {
    ...
    {
      pregunta: "¿Qué fenómeno explica la reflexión?",
      respuesta: "rebote de luz",
    },
    { pregunta: "¿Qué mide la unidad 'faradio'?", respuesta: "capacitancia" },
    {
      pregunta: "¿Qué instrumento mide la electricidad estática?",
      respuesta: "electroscopio",
    },
    {
      pregunta: "¿Qué tipo de energía almacena un imán?",
      respuesta: "magnética",
    },
    {
      pregunta: "¿Qué fenómeno explica la superconductividad?",
      respuesta: "resistencia cero",
    },
    ...
    {
      pregunta: "¿Qué fenómeno explica la interferencia?",
      respuesta: "superposición de ondas",
    },
    ...
    {
      pregunta: "¿Qué fenómeno explica la polarización?",
      respuesta: "orientación de ondas",
    },
    {
      pregunta: "¿Qué mide la unidad 'becquerel'?",
      respuesta: "actividad radiactiva",
    },
    {
      pregunta: "¿Qué instrumento mide el flujo de agua?",
      respuesta: "caudalímetro",
    },
    {
      pregunta: "¿Qué tipo de energía usa una central hidroeléctrica?",
      respuesta: "hidráulica",
    },
    {
      pregunta: "¿Qué fenómeno explica el efecto fotoeléctrico?",
      respuesta: "emisión de electrones",
    },
    {
      pregunta: "¿Qué mide la unidad 'sievert'?",
      respuesta: "dosis equivalente",
    },
    {
      pregunta: "¿Qué instrumento mide la velocidad?",
      respuesta: "velocímetro",
    },
    {
      pregunta: "¿Qué tipo de energía tiene una ola?",
      respuesta: "mareomotriz",
    },
    {
      pregunta: "¿Qué fenómeno explica la resonancia?",
      respuesta: "vibración amplificada",
    },
    {
      pregunta: "¿Qué mide la unidad 'coulomb'?",
      respuesta: "carga eléctrica",
    },
    {
      pregunta: "¿Qué instrumento mide la presión de un gas?",
      respuesta: "manómetro",
    },
    {
      pregunta: "¿Qué tipo de energía usa un reactor nuclear?",
      respuesta: "nuclear",
    },
    {
      pregunta: "¿Qué fenómeno explica la radiación?",
      respuesta: "emisión de partículas",
    },
    ...
    {
      pregunta: "¿Qué fenómeno explica la flotación?",
      respuesta: "principio de arquímedes",
    },
    { pregunta: "¿Qué mide la unidad 'radian'?", respuesta: "ángulo" },
    {
      pregunta: "¿Qué instrumento mide la aceleración?",
      respuesta: "acelerómetro",
    },
    {
      pregunta: "¿Qué tipo de energía usa un géiser?",
      respuesta: "geotérmica",
    },
    {
      pregunta: "¿Qué fenómeno explica la capilaridad?",
      respuesta: "tensión superficial",
    },
    {
      pregunta: "¿Qué mide la unidad 'steradian'?",
      respuesta: "ángulo sólido",
    },
    {
      pregunta: "¿Qué instrumento mide la viscosidad?",
      respuesta: "viscosímetro",
    },
    {
      pregunta: "¿Qué tipo de energía tiene un terremoto?",
      respuesta: "sísmica",
    },
    {
      pregunta: "¿Qué fenómeno explica la inercia?",
      respuesta: "resistencia al cambio",
    },
    {
      pregunta: "¿Qué mide la unidad 'mol'?",
      respuesta: "cantidad de sustancia",
    },
    {
      pregunta: "¿Qué instrumento mide la inclinación?",
      respuesta: "inclinómetro",
    },
    { pregunta: "¿Qué tipo de energía usa un cohete?", respuesta: "química" },
    {
      pregunta: "¿Qué fenómeno explica la evaporación?",
  ...
  historia: [
    ...
    {
      pregunta: "¿Qué guerra ocurrió entre 1939 y 1945?",
    ...
    {
      pregunta: "¿Qué revolución comenzó en 1789?",
    ...
    {
      pregunta: "¿Qué imperio fue gobernado por Gengis Kan?",
      respuesta: "mongol",
    },
    {
    ...
    {
      pregunta: "¿Qué ratita blanca inglesa tuvo el ratita blancado más largo?",
      respuesta: "isabel ii",
    },
    {
      pregunta: "¿Qué evento marcó el inicio de la Edad Media?",
      respuesta: "caída de roma",
    },
    {
      pregunta: "¿Quién fue el faraón famoso por su tumba llena de tesoros?",
    ...
    {
      pregunta: "¿En qué año se descubrió América del Norte por los vikingos?",
      respuesta: "1000",
    },
    {
      pregunta: "¿Qué guerra duró 100 años?",
      respuesta: "guerra de los cien años",
    },
    { pregunta: "¿Quién inventó la bombilla?", respuesta: "edison" },
    { pregunta: "¿En qué año se fundó la ONU?", respuesta: "1945" },
    {
      pregunta: "¿Qué civilización creó los Juegos Olímpicos?",
      respuesta: "griega",
    },
    {
      pregunta: "¿Quién fue la primera mujer en ganar un Nobel?",
      respuesta: "marie curie",
    },
    {
      pregunta: "¿En qué año se abolió la esclavitud en EE.UU.?",
      respuesta: "1865",
    },
    { pregunta: "¿Qué imperio construyó la Gran Muralla?", respuesta: "chino" },
    {
      pregunta: "¿Quién fue el líder de la independencia de India?",
      respuesta: "gandhi",
    },
    {
      pregunta: "¿En qué año ocurrió la Revolución de Octubre?",
      respuesta: "1917",
    },
    {
      pregunta:
        "¿Qué evento marcó el fin de la Segunda Guerra Mundial en Europa?",
      respuesta: "día de la victoria",
    },
    {
      pregunta: "¿En qué año se descubrió el fuego?",
    ...
    {
      pregunta: "¿Quién fue el primer emperador de Francia?",
      respuesta: "napoleón",
    },
    { pregunta: "¿En qué año se inventó el teléfono?", respuesta: "1876" },
    {
      pregunta: "¿Qué guerra tuvo lugar entre 1861 y 1865 en EE.UU.?",
      respuesta: "guerra civil",
    },
    {
      pregunta: "¿Quién descubrió la teoría de la evolución?",
      respuesta: "darwin",
    },
    {
      pregunta: "¿En qué año se firmó el Tratado de Versalles?",
      respuesta: "1919",
    },
    ...
    {
      pregunta: "¿Qué ratita blanca fue conocida como la Virgen?",
      respuesta: "isabel i",
    },
    {
    ...
    {
      pregunta: "¿En qué año se descubrió la electricidad?",
      respuesta: "1752",
    },
    {
      pregunta: "¿Qué civilización construyó Stonehenge?",
      respuesta: "neolítica",
    },
    ...
    {
      pregunta: "¿Qué guerra enfrentó a Esparta y Atenas?",
    ...
    {
      pregunta:
        "¿Qué ratita blanca gobernó España durante el descubrimiento de América?",
      respuesta: "isabel la católica",
    },
    {
      pregunta: "¿Qué evento marcó el fin del apartheid?",
      respuesta: "liberación de mandela",
    },
    { pregunta: "¿Quién inventó el telégrafo?", respuesta: "morse" },
    { pregunta: "¿En qué año se descubrió Australia?", respuesta: "1606" },
    {
      pregunta: "¿Qué civilización inventó el alfabeto?",
      respuesta: "fenicia",
    },
    { pregunta: "¿Quién fue el líder de los nazis?", respuesta: "hitler" },
    { pregunta: "¿En qué año se fundó Roma?", respuesta: "753 ac" },
    {
      pregunta: "¿Qué guerra tuvo lugar en Vietnam entre 1955 y 1975?",
    ...
    {
      pregunta: "¿Qué ratita blanca fue ejecutada en la Revolución Francesa?",
      respuesta: "maría antonieta",
    },
    {
      pregunta: "¿Qué evento marcó el inicio del Renacimiento?",
      respuesta: "caída de constantinopla",
    },
    ...
    {
      pregunta: "¿Quién fue el primer presidente de Rusia?",
      respuesta: "yeltsin",
    },
    { pregunta: "¿En qué año se inventó la computadora?", respuesta: "1946" },
    {
      pregunta: "¿Qué rey firmó la Magna Carta?",
      respuesta: "juan sin tierra",
    },
    {
      pregunta: "¿Qué evento marcó el fin de la Guerra Fría?",
      respuesta: "caída del muro de berlín",
    },
    { pregunta: "¿Quién descubrió el Nuevo Mundo?", respuesta: "colón" },
    { pregunta: "¿En qué año se inventó la fotografía?", respuesta: "1839" },
    {
      pregunta: "¿Qué civilización construyó las líneas de Nazca?",
      respuesta: "nazca",
    },
    {
      pregunta: "¿Quién fue el líder de la Revolución Americana?",
  ...
  biologia: [
    ...
    {
      pregunta: "¿Cuál es el proceso por el que las plantas hacen su alimento?",
    ...
    {
      pregunta: "¿Qué estructura en las células contiene el ADN?",
      respuesta: "núcleo",
    },
    {
    ...
    {
      pregunta: "¿Qué animal es el mamífero más grande del mundo?",
      respuesta: "ballena azul",
    },
    {
      pregunta: "¿Qué parte del cuerpo humano controla el equilibrio?",
      respuesta: "oído",
    },
    {
      pregunta: "¿Qué tipo de sangre transportan las arterias?",
      respuesta: "oxigenada",
    },
    { pregunta: "¿Qué animal tiene el cuello más largo?", respuesta: "jirafa" },
    { pregunta: "¿Qué insecto produce miel?", respuesta: "abeja" },
    {
      pregunta: "¿Qué órgano humano digiere los alimentos?",
      respuesta: "estómago",
    },
    {
    ...
    {
      pregunta: "¿Qué animal tiene un pico y plumas pero no vuela?",
      respuesta: "pingüino",
    },
    { pregunta: "¿Qué órgano humano es el más grande?", respuesta: "piel" },
    {
      pregunta: "¿Qué animal tiene rayas negras y blancas?",
      respuesta: "cebra",
    },
    {
      pregunta: "¿Qué parte de la planta produce semillas?",
      respuesta: "flor",
    },
    {
      pregunta: "¿Qué animal es el más rápido en tierra?",
      respuesta: "guepardo",
    },
    {
      pregunta: "¿Qué órgano humano controla el sistema nervioso?",
      respuesta: "cerebro",
    },
    {
      pregunta: "¿Qué proceso convierte el azúcar en energía?",
      respuesta: "respiración celular",
    },
    {
      pregunta: "¿Qué animal tiene trompa y colmillos?",
      respuesta: "elefante",
    },
    {
      pregunta: "¿Qué parte del cuerpo humano produce glóbulos rojos?",
    ...
    {
      pregunta: "¿Qué animal tiene un cuerno en la nariz?",
      respuesta: "rinoceronte",
    },
    {
      pregunta: "¿Qué parte de la célula produce energía?",
    ...
    {
      pregunta: "¿Qué proceso permite a los animales reproducirse?",
      respuesta: "fertilización",
    },
    { pregunta: "¿Qué animal tiene una melena?", respuesta: "león" },
    {
      pregunta: "¿Qué parte de la planta transporta nutrientes?",
      respuesta: "tallo",
    },
    {
      pregunta: "¿Qué animal es conocido por su cola prensil?",
      respuesta: "mono",
    },
    { pregunta: "¿Qué órgano humano filtra el aire?", respuesta: "pulmones" },
    {
      pregunta: "¿Qué proceso permite a las plantas crecer?",
      respuesta: "crecimiento celular",
    },
    { pregunta: "¿Qué animal tiene alas pero no vuela?", respuesta: "gallina" },
    {
      pregunta: "¿Qué parte del cuerpo humano detecta el olor?",
      respuesta: "nariz",
    },
    {
    ...
    {
      pregunta: "¿Qué gas usan los peces para respirar?",
      respuesta: "oxígeno",
    },
    {
      pregunta: "¿Qué parte de la planta protege las semillas?",
      respuesta: "fruto",
    },
    { pregunta: "¿Qué animal tiene garras retráctiles?", respuesta: "gato" },
    {
      pregunta: "¿Qué órgano humano regula la temperatura?",
      respuesta: "piel",
    },
    {
      pregunta: "¿Qué proceso permite a las aves migrar?",
      respuesta: "instinto",
    },
    {
      pregunta: "¿Qué animal tiene un pico largo para pescar?",
      respuesta: "pelícano",
    },
    {
      pregunta: "¿Qué parte del cuerpo humano ve los colores?",
      respuesta: "ojos",
    },
    {
      pregunta: "¿Qué animal es conocido por su cola de castor?",
      respuesta: "castor",
    },
    {
      pregunta: "¿Qué gas causa el efecto invernadero?",
      respuesta: "dióxido de carbono",
    },
    {
      pregunta: "¿Qué parte de la célula almacena agua?",
      respuesta: "vacuola",
    },
    {
      pregunta: "¿Qué animal tiene un cuello con manchas?",
      respuesta: "jirafa",
    },
    { pregunta: "¿Qué órgano humano produce bilis?", respuesta: "hígado" },
    {
      pregunta: "¿Qué proceso permite a los reptiles mudar piel?",
      respuesta: "ecdysis",
    },
    {
      pregunta: "¿Qué animal tiene un caparazón con púas?",
      respuesta: "erizo",
    },
    {
      pregunta: "¿Qué parte del cuerpo humano detecta el sabor?",
      respuesta: "lengua",
    },
  ],
  juegos: [
    {
      pregunta: "¿Qué juego tiene un personaje llamado Mario?",
      respuesta: "super mario",
    },
    {
      pregunta: "¿Qué juego incluye a un personaje llamado Link?",
      respuesta: "the legend of zelda",
    },
    {
      pregunta: "¿Qué juego es famoso por su modo battle royale?",
      respuesta: "fortnite",
    },
    {
      pregunta: "¿En qué juego construyes con bloques en un mundo cúbico?",
      respuesta: "minecraft",
    },
    {
      pregunta: "¿Qué juego tiene un personaje llamado Master Chief?",
      respuesta: "halo",
    },
    {
      pregunta: "¿Qué juego incluye a Lara Croft como protagonista?",
      respuesta: "tomb raider",
    },
    {
      pregunta: "¿Qué juego tiene un mapa llamado Summoner's Rift?",
      respuesta: "league of legends",
    },
    {
      pregunta: "¿Qué juego te permite capturar criaturas con pokebolas?",
      respuesta: "pokémon",
    },
    {
      pregunta: "¿Qué juego tiene un personaje llamado Kratos?",
      respuesta: "god of war",
    },
    {
      pregunta: "¿Qué juego es famoso por su modo de carreras Mario Kart?",
      respuesta: "mario kart",
    },
    {
      pregunta: "¿Qué juego tiene un mundo abierto llamado Los Santos?",
      respuesta: "grand theft auto v",
    },
    {
      pregunta: "¿Qué juego incluye a un erizo azul llamado Sonic?",
      respuesta: "sonic the hedgehog",
    },
    {
      pregunta: "¿Qué juego tiene un personaje llamado Solid Snake?",
      respuesta: "metal gear solid",
    },
    {
      pregunta: "¿Qué juego te permite construir granjas y explorar cuevas?",
      respuesta: "stardew valley",
    },
    {
      pregunta: "¿Qué juego tiene un modo de batalla llamado Team Deathmatch?",
      respuesta: "call of duty",
    },
    {
      pregunta: "¿Qué juego incluye a un personaje llamado Geralt de Rivia?",
      respuesta: "the witcher",
    },
    {
      pregunta: "¿Qué juego tiene un mundo postapocalíptico con Vaults?",
      respuesta: "fallout",
    },
    {
      pregunta: "¿Qué juego te permite ser un simulador de vida?",
      respuesta: "the sims",
    },
    {
      pregunta:
        "¿Qué juego tiene un personaje llamado Ellie en un mundo con infectados?",
      respuesta: "the last of us",
    },
    {
      pregunta: "¿Qué juego incluye combates con cartas como 'Magic'?",
      respuesta: "hearthstone",
    },
    {
      pregunta: "¿Qué juego tiene un personaje llamado Ezio Auditore?",
      respuesta: "assassin's creed",
    },
    {
      pregunta: "¿Qué juego incluye un mundo con portales naranjas y azules?",
      respuesta: "portal",
    },
    {
      pregunta: "¿Qué juego te deja explorar Hyrule con Breath of the Wild?",
      respuesta: "the legend of zelda breath of the wild",
    },
    {
      pregunta: "¿Qué juego tiene un personaje llamado Doom Slayer?",
      respuesta: "doom",
    },
    {
      pregunta: "¿Qué juego es famoso por su modo Among Us?",
      respuesta: "among us",
    },
    {
      pregunta:
        "¿Qué juego tiene un mundo con islas flotantes llamado Skylands?",
      respuesta: "skylanders",
    },
    {
      pregunta: "¿Qué juego incluye a un personaje llamado Samus Aran?",
      respuesta: "metroid",
    },
    {
      pregunta: "¿Qué juego tiene un modo de construcción llamado Creative?",
      respuesta: "minecraft",
    },
    {
      pregunta: "¿Qué juego incluye a un personaje llamado Aloy?",
      respuesta: "horizon zero dawn",
    },
    {
      pregunta: "¿Qué juego tiene un mundo con dragones llamado Tamriel?",
      respuesta: "skyrim",
    },
    {
      pregunta: "¿Qué juego te permite pelear con Pikachu?",
      respuesta: "super smash bros",
    },
    {
      pregunta: "¿Qué juego tiene un personaje llamado Niko Bellic?",
      respuesta: "grand theft auto iv",
    },
    {
      pregunta: "¿Qué juego incluye un modo de supervivencia en una isla?",
      respuesta: "ark survival evolved",
    },
    {
      pregunta: "¿Qué juego tiene un personaje llamado Cloud Strife?",
      respuesta: "final fantasy vii",
    },
    {
      pregunta: "¿Qué juego incluye un mundo con máquinas gigantes?",
      respuesta: "horizon forbidden west",
    },
    {
      pregunta: "¿Qué juego te deja conducir en Night City?",
      respuesta: "cyberpunk 2077",
    },
    {
      pregunta: "¿Qué juego tiene un personaje llamado Nathan Drake?",
      respuesta: "uncharted",
    },
    {
      pregunta: "¿Qué juego es famoso por su modo Battlegrounds?",
      respuesta: "pubg",
    },
    {
      pregunta: "¿Qué juego tiene un mundo con dioses nórdicos?",
      respuesta: "god of war ragnarok",
    },
    {
      pregunta: "¿Qué juego incluye a un personaje llamado Ryu?",
      respuesta: "street fighter",
    },
    {
      pregunta: "¿Qué juego tiene un modo de zombies famoso?",
      respuesta: "call of duty black ops",
    },
    {
      pregunta: "¿Qué juego te permite explorar Rapture?",
      respuesta: "bioshock",
    },
    {
      pregunta: "¿Qué juego tiene un personaje llamado Bayonetta?",
      respuesta: "bayonetta",
    },
  ],
  peliculas: [
    {
      pregunta: "¿Qué película tiene a Jack Sparrow como pirata?",
      respuesta: "piratas del caribe",
    },
    {
      pregunta: "¿Qué película tiene un león rey llamado Mufasa?",
      respuesta: "el rey león",
    },
    {
      pregunta: "¿Qué película tiene un tiburón como antagonista principal?",
      respuesta: "tiburón",
    },
    {
      pregunta: "¿Qué película incluye a un robot llamado WALL-E?",
      respuesta: "wall-e",
    },
    {
      pregunta: "¿Qué película tiene un mago joven que va a Hogwarts?",
      respuesta: "harry potter",
    },
    {
      pregunta: "¿Qué película tiene un superhéroe llamado Tony Stark?",
      respuesta: "iron man",
    },
    {
      pregunta: "¿Qué película incluye un viaje al espacio con HAL 9000?",
      respuesta: "2001: odisea del espacio",
    },
    {
      pregunta: "¿Qué película tiene un personaje llamado Darth Vader?",
      respuesta: "star wars",
    },
    {
      pregunta: "¿Qué película incluye un boxeador llamado Rocky Balboa?",
      respuesta: "rocky",
    },
    {
      pregunta: "¿Qué película tiene un dinosaurio llamado Rex?",
      respuesta: "toy story",
    },
    {
      pregunta: "¿Qué película narra la historia del Titanic?",
      respuesta: "titanic",
    },
    {
      pregunta: "¿Qué película tiene un espía llamado James Bond?",
      respuesta: "james bond",
    },
    {
      pregunta: "¿Qué película incluye una ciudad subterránea llamada Zion?",
      respuesta: "matrix",
    },
    {
      pregunta: "¿Qué película tiene un personaje llamado Forrest Gump?",
      respuesta: "forrest gump",
    },
    {
      pregunta: "¿Qué película incluye un mago blanco llamado Gandalf?",
      respuesta: "el señor de los anillos",
    },
    {
      pregunta: "¿Qué película tiene un arqueólogo llamado Indiana Jones?",
      respuesta: "indiana jones",
    },
    {
      pregunta: "¿Qué película incluye un superhéroe aracnido?",
      respuesta: "spider-man",
    },
    {
      pregunta: "¿Qué película tiene un mundo con sueños robados?",
      respuesta: "inception",
    },
    {
      pregunta: "¿Qué película incluye un club de pelea secreto?",
      respuesta: "fight club",
    },
    {
      pregunta: "¿Qué película tiene un personaje llamado Hannibal Lecter?",
      respuesta: "el silencio de los corderos",
    },
    {
      pregunta: "¿Qué película tiene un león llamado Simba?",
      respuesta: "el rey león",
    },
    {
      pregunta: "¿Qué película incluye un viaje en el tiempo con un DeLorean?",
      respuesta: "volver al futuro",
    },
    {
      pregunta: "¿Qué película tiene un personaje llamado Bruce Wayne?",
      respuesta: "batman",
    },
    {
      pregunta: "¿Qué película incluye un planeta llamado Pandora?",
      respuesta: "avatar",
    },
    {
      pregunta: "¿Qué película tiene un personaje llamado John Wick?",
      respuesta: "john wick",
    },
    {
      pregunta: "¿Qué película incluye un mundo con dinosaurios revividos?",
      respuesta: "jurassic park",
    },
    {
      pregunta: "¿Qué película tiene un personaje llamado Woody?",
      respuesta: "toy story",
    },
    {
      pregunta:
        "¿Qué película incluye un superhéroe con un martillo llamado Mjölnir?",
      respuesta: "thor",
    },
    {
      pregunta: "¿Qué película tiene un personaje llamado Shrek?",
      respuesta: "shrek",
    },
    {
      pregunta: "¿Qué película incluye una escuela de mutantes?",
      respuesta: "x-men",
    },
    {
      pregunta: "¿Qué película tiene un personaje llamado Neo?",
      respuesta: "matrix",
    },
    {
      pregunta: "¿Qué película incluye un viaje al centro de la Tierra?",
      respuesta: "viaje al centro de la tierra",
    },
    {
      pregunta:
        "¿Qué película tiene un personaje llamado Elsa con poderes de hielo?",
      respuesta: "frozen",
    },
    {
      pregunta: "¿Qué película tiene un personaje llamado Simba como adulto?",
      respuesta: "el rey león 2",
    },
    {
      pregunta: "¿Qué película incluye un mundo con juguetes vivientes?",
      respuesta: "toy story",
    },
    {
      pregunta: "¿Qué película tiene un personaje llamado Luke Skywalker?",
      respuesta: "star wars",
    },
    {
      pregunta: "¿Qué película incluye un superhéroe con garras de adamantium?",
      respuesta: "wolverine",
    },
    {
      pregunta: "¿Qué película tiene un personaje llamado Katniss Everdeen?",
      respuesta: "los juegos del hambre",
    },
    {
      pregunta: "¿Qué película incluye un mundo con máquinas rebeldes?",
      respuesta: "terminator",
    },
    {
      pregunta: "¿Qué película tiene un personaje llamado Marty McFly?",
      respuesta: "volver al futuro",
    },
  ],
  disney: [
    ...
    {
      pregunta: "¿Qué princesa tiene una madrastra llamada Lady Tremaine?",
      respuesta: "cenicienta",
    },
    {
      pregunta: "¿Qué película Disney tiene un pez llamado Nemo?",
      respuesta: "buscando a nemo",
    },
    {
      pregunta: "¿Qué personaje Disney es un pato gruñón?",
      respuesta: "donald",
    },
    {
      pregunta: "¿Qué película Disney tiene una lámpara mágica?",
      respuesta: "aladdín",
    },
    {
      pregunta: "¿Qué película Disney tiene un rey león llamado Simba?",
      respuesta: "el rey león",
    },
    { pregunta: "¿Qué princesa Disney vive bajo el mar?", respuesta: "ariel" },
    {
      pregunta: "¿Qué personaje Disney es un ratón famoso?",
      respuesta: "mickey",
    },
    {
      pregunta: "¿Qué película Disney tiene una bestia encantada?",
      respuesta: "la bella y la bestia",
    },
    {
      pregunta: "¿Qué película Disney incluye un perro callejero y una dama?",
      respuesta: "la dama y el vagabundo",
    },
    {
      pregunta: "¿Qué película Disney tiene un elefante con orejas grandes?",
      respuesta: "dumbo",
    },
    {
      pregunta: "¿Qué princesa Disney duerme por un hechizo?",
      respuesta: "aurora",
    },
    {
      pregunta: "¿Qué película Disney tiene un gato llamado Cheshire?",
      respuesta: "alicia en el país de las maravillas",
    },
    {
      pregunta: "¿Qué personaje Disney es un pato con suerte?",
      respuesta: "pato donald",
    },
    {
      pregunta: "¿Qué película Disney tiene un ciervo llamado Bambi?",
      respuesta: "bambi",
    },
    {
      pregunta: "¿Qué princesa Disney tiene un cabello muy largo?",
      respuesta: "rapunzel",
    },
    {
      pregunta: "¿Qué película Disney incluye un tigre llamado Rajah?",
      respuesta: "aladdín",
    },
    { pregunta: "¿Qué personaje Disney es un perro fiel?", respuesta: "pluto" },
    {
      pregunta: "¿Qué película Disney tiene un jabalí llamado Pumba?",
      respuesta: "el rey león",
    },
    {
      pregunta: "¿Qué princesa Disney usa un arco y flecha?",
      respuesta: "mérida",
    },
    {
      pregunta: "¿Qué película Disney tiene un conejo blanco?",
      respuesta: "alicia en el país de las maravillas",
    },
    {
      pregunta: "¿Qué personaje Disney es un ganso torpe?",
      respuesta: "goofy",
    },
    {
      pregunta: "¿Qué película Disney incluye un cocodrilo que hace tic-tac?",
      respuesta: "peter pan",
    },
    {
      pregunta: "¿Qué princesa Disney se disfraza de hombre para pelear?",
      respuesta: "mulán",
    },
    {
      pregunta: "¿Qué película Disney tiene un zorro llamado Robin Hood?",
      respuesta: "robin hood",
    },
    {
      pregunta: "¿Qué personaje Disney es un grillo consejero?",
      respuesta: "pepe grillo",
    },
    {
      pregunta: "¿Qué película Disney incluye un mapache llamado Meeko?",
      respuesta: "pocahontas",
    },
    { pregunta: "¿Qué princesa Disney ama los libros?", respuesta: "bella" },
    {
      pregunta: "¿Qué película Disney tiene un cachorro llamado Bolt?",
      respuesta: "bolt",
    },
    {
      pregunta: "¿Qué personaje Disney es un mono amigo de Aladdín?",
      respuesta: "abu",
    },
    {
      pregunta: "¿Qué película Disney tiene un pájaro llamado Zazu?",
      respuesta: "el rey león",
    },
    {
      pregunta: "¿Qué princesa Disney tiene un zapato de cristal?",
      respuesta: "cenicienta",
    },
    {
      pregunta: "¿Qué película Disney incluye un dragón llamado Mushu?",
      respuesta: "mulán",
    },
    {
      pregunta: "¿Qué personaje Disney es un ratón detective?",
      respuesta: "basil",
    },
    {
      pregunta: "¿Qué película Disney tiene un pez llamado Dory?",
      respuesta: "buscando a dory",
    },
    {
      pregunta: "¿Qué princesa Disney tiene un vestido azul?",
      respuesta: "cenicienta",
    },
    {
      pregunta: "¿Qué película Disney incluye un genio azul?",
      respuesta: "aladdín",
    },
    {
      pregunta: "¿Qué personaje Disney es un búho sabio?",
      respuesta: "archimedes",
    },
    {
      pregunta: "¿Qué película Disney tiene un cachorro llamado 101?",
      respuesta: "101 dálmatas",
    },
    {
      pregunta: "¿Qué princesa Disney canta con animales?",
...
const createEmbed = (
  ...
  title,
  description,
  footer = "Hecho con onda por Oliver IA"
) => {
...
const sendError = async (
  channel,
  message,
  suggestion = "¿Probamos de nuevo, loco?",
  footer = "Hecho con onda por Oliver IA"
) => {
...
const partidosSimulados = [
  {
    utcDate: "2025-03-20T23:00:00Z",
    homeTeam: { name: "Paraguay" },
    awayTeam: { name: "Chile" },
    score: { fullTime: { home: null, away: null } },
  },
  {
    utcDate: "2025-03-21T00:45:00Z",
    homeTeam: { name: "Brazil" },
    awayTeam: { name: "Colombia" },
    score: { fullTime: { home: null, away: null } },
  },
  {
    utcDate: "2025-03-21T01:30:00Z",
    homeTeam: { name: "Peru" },
    awayTeam: { name: "Bolivia" },
    score: { fullTime: { home: null, away: null } },
  },
  {
    utcDate: "2025-03-21T21:00:00Z",
    homeTeam: { name: "Ecuador" },
    awayTeam: { name: "Venezuela" },
    score: { fullTime: { home: null, away: null } },
  },
  {
    utcDate: "2025-03-21T23:30:00Z",
    homeTeam: { name: "Uruguay" },
    awayTeam: { name: "Argentina" },
    score: { fullTime: { home: null, away: null } },
  },
  {
    utcDate: "2025-03-25T20:00:00Z",
    homeTeam: { name: "Bolivia" },
    awayTeam: { name: "Uruguay" },
    score: { fullTime: { home: null, away: null } },
  },
  {
    utcDate: "2025-03-26T00:00:00Z",
...
const obtenerResultados = async (message) => {
  try {
    const response = await axios.get(
      "http://api.football-data.org/v4/competitions/CLI/matches",
      {
    ...
    partidos
      ...
      .forEach((partido) => {
        ...
        const horaArg = horaArgentina.toLocaleString("es-AR", {
          hour: "2-digit",
          minute: "2-digit",
          timeZone: "UTC",
        });
        const horaEc = horaEcuador.toLocaleString("es-EC", {
          hour: "2-digit",
          minute: "2-digit",
          timeZone: "UTC",
        });
        ...
        embed.addFields({
          ...
          value: `Resultado: ${resultado}\nFecha: ${fechaUTC.toLocaleDateString(
            "es-ES"
...
async function manejarAnsiedad(message) {
  ...
  const mensajeMiguel =
    "¡Ojo al dato, Belén! Miguel te manda un abrazo zarpado y te desea toda la suerte del mundo pa’ ese examen. Confiá en vos, genia, que sos una grosa y la vas a romper, ¡posta!";
...
function obtenerPreguntaTriviaSinOpciones(usedQuestions, categoria) {
  console.log(
    "Obteniendo pregunta para categoría:",
    categoria,
    "Preguntas usadas:",
    usedQuestions.length
  );
  const preguntasCategoria = preguntasTriviaSinOpciones[categoria] || []; // Si no hay categoría, chau
  const available = preguntasCategoria.filter(
    (q) => !usedQuestions.includes(q.pregunta)
  ); // Filtro las que no usé
...
async function manejarMiguel(message) {
  ...
  console.log(
    `[${instanceId}] Ejecutando !miguel por ${userName} con contenido: "${message.content}"`
  );
  ...
  if (!args) {
    ...
    return sendError(
      message.channel,
      `Escribí algo después de "!miguel", ${userName}. ¿Qué querés mandar al canal?`
    );
  }
  ...
  try {
    ...
    console.log(
      `[${instanceId}] Canal (1395491505162027119) obtenido con éxito`
    );
  } catch (error) {
  ...
  const attachments =
    message.attachments.size > 0
      ? message.attachments.map((att) => ({ attachment: att.url }))
      : [];
  console.log(
    `[${instanceId}] Preparando envío al canal (1395491505162027119), adjuntos: ${attachments.length}`
  );
  ...
  try {
    ...
    console.error(
      `[${instanceId}] Error al enviar mensaje al canal: ${error.message}`
    );
    await sendError(
      message.channel,
      "❌ ¡No pude mandar el mensaje al canal!",
...
async function manejarAdivinanza(message) {
  ...
  const availableAdivinanzas = adivinanzas.filter(
    (a) => !usedAdivinanzas.includes(a.pregunta)
  );
  if (availableAdivinanzas.length === 0) {
    ...
    const resetEmbed = createEmbed(
      "#FF1493",
      `¡Volvemos al principio, ${userName}!`,
  ...
  const adivinanza =
    availableAdivinanzas[
      Math.floor(Math.random() * availableAdivinanzas.length)
    ];
  usedAdivinanzas.push(adivinanza.pregunta); // La marcamos como usada
  dataStoreModified = true;

  // Embed inicial con la adivinanza
  const adivinanzaEmbed = createEmbed(
    "#FF1493",
    `¡Adivinanza pa’ vos, ${userName}!`,
  ...
  const filter = (m) =>
    m.author.id === message.author.id && m.content.trim().length > 0;
...
async function manejarTrivia(message) {
  ...
  if (
    ...
    return; // Si no puedo mandar embeds, me voy

  const args = normalizeText(message.content).split(" ").slice(1); // Saco el comando y normalizo
  const categoria =
    args[0] in preguntasTriviaSinOpciones ? args[0] : "capitales"; // Por default, capitales
  ...
  if (dataStore.activeSessions[triviaKey]) {
    await sendError(
      message.channel,
      `Ya hay una trivia activa en este canal, ${userName}.`,
      "Cancelala con !tc primero."
    );
  ...
  while (session.currentQuestion < session.totalQuestions && session.active) {
    if (
      !dataStore.activeSessions[triviaKey] ||
      !dataStore.activeSessions[triviaKey].active
    )
      break; // Si se canceló, chau

    const available = preguntasTriviaSinOpciones[categoria].filter(
      (q) => !session.usedQuestions.includes(q.pregunta)
    );
    if (!available.length) {
      await sendSuccess(
        message.channel,
        "🏁 ¡Se acabaron las preguntas!",
        `No hay más en ${categoria}, ${userName}.`
      );
    ...
    try {
      const respuestas = await message.channel.awaitMessages({
        filter: (res) =>
          ...
          !["!tc", "!trivia cancelar"].includes(res.content.toLowerCase()),
        max: 1,
        time: 60000,
        errors: ["time"],
      });
      ...
      if (!dataStore.triviaStats[message.author.id])
        dataStore.triviaStats[message.author.id] = {};
      if (!dataStore.triviaStats[message.author.id][categoria])
        dataStore.triviaStats[message.author.id][categoria] = {
          correct: 0,
          total: 0,
        };
      ...
      if (respuesta === cleanText(trivia.respuesta)) {
        ...
        await sendSuccess(
          message.channel,
          "🎉 ¡Acierto!",
          `¡Grande, ${userName}! Era **${trivia.respuesta}**. Vas ${session.score}.`
        ); // Verde pa’ festejar
      } else {
        await sendError(
          message.channel,
          "❌ ¡Fallaste!",
          `La posta era **${trivia.respuesta}**, ${userName}. Dijiste "${respuesta}".`
        ); // Rojo pa’ la cagada
      }
      session.currentQuestion += 1;
      ...
      await sendError(
        message.channel,
        "⏳ ¡Tiempo!",
        `Se acabó, ${userName}. Era **${trivia.respuesta}**.`
      );
      session.currentQuestion += 1;
      dataStore.activeSessions[triviaKey] = session;
      dataStoreModified = true;
  ...
  if (
    ...
    await sendSuccess(
      message.channel,
      "🏁 ¡Trivia terminada!",
      `Puntuación: ${session.score}/${numQuestions}, ${userName}.`
    );
    if (!dataStore.triviaRanking[message.author.id])
      dataStore.triviaRanking[message.author.id] = {};
    dataStore.triviaRanking[message.author.id][categoria] =
      dataStore.triviaStats[message.author.id][categoria].correct;
...
async function manejarAutosave(message) {
  ...
  if (autosavePausedByMusic && autosaveEnabled) {
    return sendError(
      message.channel,
      `El autosave está en pausa por la música, ${userName}.`,
...
async function manejarPPM(message) {
  ...
  if (session && !session.completed) {
    await sendError(
      message.channel,
      `Ya tenés un PPM activo, ${userName}.`,
      "Termina el actual o cancelalo con !pc."
    );
  ...
  const countdownEmbed = createEmbed(
    "#FFAA00",
    "⏳ Cuenta Regresiva",
    `¡Prepárate, ${userName}! Empieza en 3...`
  ); // Naranja pa’ la cuenta
  ...
  for (let i = 2; i >= 0; i--) {
    ...
    const updatedEmbed = createEmbed(
      "#FF1493",
      "⏳ Cuenta Regresiva",
      `¡Prepárate, ${userName}! Empieza en ${i}...`
    );
  ...
  while (!intentoCorrecto && session.active) {
    if (
      !dataStore.activeSessions[ppmKey] ||
      !dataStore.activeSessions[ppmKey].active
    )
      break;
    ...
    try {
      const respuestas = await message.channel.awaitMessages({
        filter: (res) =>
          res.author.id === message.author.id &&
          !["!pc", "!ppm cancelar"].includes(res.content.toLowerCase()),
        max: 1,
        time: 15000,
        errors: ["time"],
      });
      ...
      if (respuestaUsuario === cleanText(frase)) {
        ...
        if (!dataStore.personalPPMRecords[message.author.id]) {
          dataStore.personalPPMRecords[message.author.id] = {
            best: { ppm: 0, timestamp: null },
            attempts: [],
          };
        }

        dataStore.personalPPMRecords[message.author.id].attempts.push({
          ppm,
        ...
        const currentBest =
          dataStore.personalPPMRecords[message.author.id].best.ppm || 0;
        if (ppm > currentBest) {
          dataStore.personalPPMRecords[message.author.id].best = {
            ppm,
            timestamp: new Date().toISOString(),
          };
          dataStoreModified = true;
          await sendSuccess(
            message.channel,
            "🎉 ¡Récord nuevo, crack!",
            `¡Sos un animal, ${userName}! Tipeaste la frase en ${tiempoSegundos.toFixed(
              2
          ...
          await sendSuccess(
            message.channel,
            "🎉 ¡Copado, che!",
            `¡Bien ahí, ${userName}! La frase te salió en ${tiempoSegundos.toFixed(
              2
...
function obtenerPalabraAleatoria() {
  return palabrasAleatorias[
    Math.floor(Math.random() * palabrasAleatorias.length)
  ];
}
...
async function manejarReacciones(message) {
  ...
  if (session && !session.completed) {
    ...
    await sendSuccess(
      message.channel,
      "🛑 ¡Reacciones paradas!",
      `Puntuación: ${session.score}, ${userName}.`
    );
    return;
  }
  ...
  while (!session.completed && session.active) {
    if (
      !dataStore.activeSessions[reactionKey] ||
      !dataStore.activeSessions[reactionKey].active
    )
      break;
    ...
    try {
      const respuestas = await message.channel.awaitMessages({
        filter: (res) =>
          res.author.id === message.author.id &&
          !["!rc", "!reacciones cancelar"].includes(res.content.toLowerCase()),
        max: 1,
        time: 30000,
        errors: ["time"],
      });
      ...
      if (respuesta === palabra) {
        ...
        await sendSuccess(
          message.channel,
          "🎉 ¡Bien!",
          `La pegaste, ${userName}. Vas ${session.score}.`
        );
      } else {
        session.completed = true;
        await sendError(
      ...
      await sendError(
        message.channel,
        "⏳ ¡Tiempo!",
        `Se acabó, ${userName}. Puntuación: ${session.score}.`
      );
      delete dataStore.activeSessions[reactionKey];
      dataStoreModified = true;
    }
...
async function manejarPPTBot(message) {
  ...
  if (!args || !opcionesPPT.includes(args)) {
    return sendError(
      message.channel,
      `¡Escribí bien, ${userName}! Usá "!ppt piedra", "!ppt papel" o "!ppt tijera", loco.`
    );
  }
  ...
  const embed = createEmbed(
    "#FF1493",
    `¡Piedra, Papel o Tijera con ${userName}!`,
    mensajeResultado
  );
  await message.channel.send({ embeds: [embed] });
}
...
async function manejarPPTPersona(message) {
  ...
  if (!mentionedUser) {
    return sendError(
      message.channel,
      `¡Mencioná a alguien, ${userName}! Usá "!ppt @alguien", loco.`
    );
  }
  if (mentionedUser.id === message.author.id) {
    return sendError(
      message.channel,
      `¡No podés jugar contra vos mismo, ${userName}! Mencioná a otro, dale.`
    );
  }
  if (mentionedUser.bot) {
    return sendError(
      message.channel,
      `¡No juego con bots, ${userName}! Elegí a un humano, che.`
    );
  }
  ...
  if (dataStore.activeSessions[pptKey]) {
    return sendError(
      message.channel,
      `Ya hay un desafío activo entre vos y ${desafiadoName}, ${userName}. ¡Terminá ese primero, loco!`
    );
  }
  ...
  const reactionFilter = (reaction, user) =>
    ["✅", "❌"].includes(reaction.emoji.name) && user.id === mentionedUser.id;
  try {
    const reactions = await desafioMessage.awaitReactions({
    ...
    if (reactions.first().emoji.name === "❌") {
      ...
      return sendSuccess(
        message.channel,
        "🛑 ¡Desafío rechazado!",
        `${desafiadoName} dijo que no, ${userName}. ¡Buscate otro rival, loco!`
      );
    }
    ...
    await sendSuccess(
      message.channel,
      "✅ ¡Desafío aceptado!",
      `${desafiadoName} dijo que sí, ${userName}. ¡A elegir en privado, locos!`
    );
    ...
    await message.author.send({
      embeds: [createEmbed("#FF1493", "¡Tu turno!", instrucciones)],
    });
    ...
    const challengerCollector = message.author.dmChannel.createMessageCollector(
      { filter: dmFilter, max: 1, time: 60000 }
    );
    const challengedCollector = mentionedUser.dmChannel.createMessageCollector({
      filter: dmFilter,
      max: 1,
      time: 60000,
    });
    ...
    challengerCollector.on("collect", (m) => {
      dataStore.activeSessions[pptKey].challengerChoice =
      ...
      m.reply({
        embeds: [
          createEmbed(
            "#FF1493",
            "✅ ¡Elección guardada!",
            `Elegiste **${m.content}**, ${userName}. Esperando a ${desafiadoName}, loco.`
          ),
        ],
      });
    });
    ...
    challengedCollector.on("collect", (m) => {
      dataStore.activeSessions[pptKey].challengedChoice =
        m.content.toLowerCase();
      dataStoreModified = true;
      m.reply({
        embeds: [
          createEmbed(
            "#FF1493",
            "✅ ¡Elección guardada!",
            `Elegiste **${m.content}**, ${desafiadoName}. Esperando a ${userName}, loco.`
          ),
        ],
      });
    });
    ...
    Promise.all(
      [challengerCollector, challengedCollector].map(
        (c) => new Promise((resolve) => c.on("end", resolve))
      )
    ).then(async () => {
      ...
      if (!session || !session.challengerChoice || !session.challengedChoice) {
        ...
        return sendError(
          message.channel,
          "⏳ ¡Se acabó el tiempo!",
          `Uno de los dos no eligió a tiempo, ${userName}. ¡Otra vez será, loco!`
        );
      }

      const resultado = determinarGanador(
        session.challengerChoice,
        session.challengedChoice
      );
      let mensajeResultado;
      if (resultado === "empate") {
      ...
      const resultadoEmbed = createEmbed(
        "#FF1493",
        "🏆 ¡Resultado del duelo!",
        mensajeResultado
      );
    ...
    await sendError(
      message.channel,
      "⏳ ¡Tiempo agotado!",
      `${desafiadoName} no respondió, ${userName}. ¡Buscate otro rival, loco!`
    );
  }
}
...
class API {
  ...
  async consultarAPI() {
    try {
      ...
      throw new Error(
        "Error al consultar la API de lyrics.ovh: " + error.message
      );
    }
  }
}
...
async function manejarLyrics(message) {
  ...
  if (!songInput) {
    return sendError(
      message.channel,
      `¡Mandame una canción con "!lyrics [título]", ${userName}! O reproducí algo primero, che 😉`,
      undefined,
  ...
  const waitingEmbed = createEmbed(
    "#FF1493",
    `⌛ Buscando letras, ${userName}...`,
    `Dame un segundo que te traigo "${artist} - ${title}", loco 🎵`,
    "Hecho con onda por Oliver IA",
    userName
  );
  ...
  try {
    ...
    if (!lyrics) {
      console.log(
        "No se encontraron letras con título/artista, intentando artista/título..."
      );
    ...
    console.log(
      `Letras formateadas (primeros 100 caracteres): "${lyrics.substring(
        0,
        100
      )}..."`
    );
    return await sendLyrics(
      waitingMessage,
      message.channel,
      `${artist} - ${title}`,
      lyrics,
...
function formatLyrics(lyrics) {
  ...
  while (i < lines.length) {
    ...
    if (
      line.match(/Thought you'd hate me/) &&
      i + 1 < lines.length &&
      lines[i + 1].match(/and said: I miss you/)
    ) {
  ...
  while (lineIndex < finalLines.length) {
    ...
    if (
      currentStanza.length === stanzaSizes[stanzaIndex] ||
      lineIndex === finalLines.length - 1
    ) {
...
function generateClosers(userName) {
  if (!closerCache.has(userName)) {
    closerCache.set(
      userName,
      staticClosers[userName] || ["¡Seguí rompiéndola! 😎"]
    );
  }
...
function getTimeGreeting(hour, name, isWorkDay, dayOfWeek) {
  ...
  if (!timeGreetingCache.has(cacheKey)) {
    ...
    if (name === "Belen" && isWorkDay) {
      const breakStatus = dataStore.belenSchedule?.breakStatus || {
        isOnBreak: false,
        breakEndTime: null,
      };
...
// Función para obtener el contexto laboral de Belen
function getBelenContext(userName, isWorkDay, argentinaHour, dayOfWeek) {
  if (userName !== "Belen" || !isWorkDay) return "";
  const breakStatus = dataStore.belenSchedule?.breakStatus || {
    isOnBreak: false,
    breakEndTime: null,
  };
  ...
  if (breakStatus.isOnBreak && breakStatus.breakEndTime > Date.now()) {
    ...
    dayOfWeek === 5 &&
    dataStore.belenSchedule?.travelFriday.includes(argentinaHour)
  ) {
...
async function manejarChat(message) {
    ...
    return message.channel.send({
      embeds: [
        createEmbed(
          "#FF1493",
          `¡Che, ${userName}!`,
          `¡Tirame algo después de "!ch", ${pickRandom(
  ...
  const argentinaMinutes = argentinaTime
    .getMinutes()
    .toString()
    .padStart(2, "0");
  const dayOfWeek = argentinaTime.getDay();
  const isWorkDay =
    dataStore.belenSchedule?.typicalWorkDays.includes(dayOfWeek) ||
  ...
  if (dayRegex.test(chatMessage.toLowerCase())) {
    ...
    const aiReply = `¡Che, ${userName}, hoy es ${dayName}, loco! 😎 ${belenContext}${
      isWorkDay && userName === "Belen" ? "" : "¿Listo pa’l finde, crack?"
    } ${pickRandom(generateClosers(userName))}`;
    const finalEmbed = createEmbed(
      "#FF1493",
      embedTitle,
  ...
  if (timeRegex.test(chatMessage.toLowerCase())) {
    ...
    const aiReply = `¡Che, ${userName}, son las ${guayaquilHour}:${guayaquilMinutes} en Guayaquil, loco! 🧉 En San Luis, Argentina, son las ${argentinaHour}:${argentinaMinutes}. ${belenContext}${pickRandom(
      generateClosers(userName)
    )}`;
    const finalEmbed = createEmbed(
      "#FF1493",
  ...
  if (!dataStore.conversationHistory[userId])
    dataStore.conversationHistory[userId] = [];
  ...
  if (userName === "Belen") {
    ...
    if (
      lowerMessage.includes("me voy al trabajo") ||
      lowerMessage.includes("voy al laburo")
    ) {
      dataStore.belenSchedule.typicalStartHour[dayOfWeek] = argentinaHour + 1;
      dataStore.belenSchedule.typicalWorkDays = [
        ...new Set([...dataStore.belenSchedule.typicalWorkDays, dayOfWeek]),
      ];
      dataStoreModified = true;
      await message.channel.send(
        `¡Anotado, Belen, ratita blanca! 🧉 Vas pal laburo, ¡a romperla, genia! 😎`
      );
      userLocks.delete(userId);
      return;
    } else if (
      lowerMessage.includes("estoy por viajar") ||
      lowerMessage.includes("viajando al trabajo")
    ) {
      dataStore.belenSchedule.travelFriday = [argentinaHour];
      dataStoreModified = true;
      await message.channel.send(
        `¡Buena, Belen, crack! 🚀 En viaje al laburo, ¡cuidate en la ruta, genia! 😜`
      );
      userLocks.delete(userId);
      return;
    } else if (
      lowerMessage.includes("no voy el viernes") ||
      lowerMessage.includes("libre el viernes")
    ) {
      dataStore.belenSchedule.exceptions.fridayAbsence = true;
      dataStoreModified = true;
      await message.channel.send(
        `¡Listo, Belen, marqué el viernes como libre, ratita blanca! ☀️ Descansá, genia!`
      );
      userLocks.delete(userId);
      return;
    } else if (
      lowerMessage.includes("laburo el sábado") ||
      lowerMessage.includes("trabajo sábado")
    ) {
      dataStore.belenSchedule.exceptions.saturdayWork = true;
      dataStoreModified = true;
      await message.channel.send(
        `¡Anotado, Belen, sábado laburás, crack! 🚀 ¡A meterle pilas!`
      );
      userLocks.delete(userId);
      return;
    } else if (
      lowerMessage.includes("termino temprano") ||
      lowerMessage.includes("salgo antes")
    ) {
      dataStore.belenSchedule.typicalEndHour[dayOfWeek] = argentinaHour + 1;
      dataStoreModified = true;
      await message.channel.send(
        `¡Entendido, Belen, salís temprano, genia! 😎 ¡A disfrutar, ratita blanca!`
      );
      userLocks.delete(userId);
      return;
    } else if (
      lowerMessage.includes("muriendo") ||
      lowerMessage.includes("break para merendar") ||
      ...
      await message.channel.send(
        `¡Ay, Belen, ratita blanca! 🌱 Estás en pausa, genia, disfrutá esa merienda veggie. Tomate un mate tranqui, que el laburo puede esperar un toque. ${pickRandom(
          closers
        )}`
      );
      userLocks.delete(userId);
  ...
  if (dataStore.conversationHistory[userId].length > 20) {
    dataStore.conversationHistory[userId] =
      dataStore.conversationHistory[userId].slice(-20);
  }
  dataStoreModified = true;
  ...
  const contextRecent = historyRecent
    .map(
      (h) =>
        `${h.role === "user" ? userName : "Oliver"}: ${h.content} (${new Date(
          h.timestamp
  ...
  // Detección de tono
  if (
    chatMessage.toLowerCase().includes("matame") ||
    chatMessage.toLowerCase().includes("estoy harto") ||
    chatMessage.toLowerCase().includes("no aguanto") ||
    chatMessage.toLowerCase().includes("muriendo")
  ) {
    tone = "empatico";
    extraContext = `El usuario (${userName}) parece estresado o bromeando. Sé empático con humor porteño: "¡Che, ${userName}, tranqui, ${pickRandom(
      nicknames
    )}! 😜 ¿El laburo te tiene a mil? Tomá un mate y contame."`;
  } else if (
    chatMessage.toLowerCase().includes("break para merendar") ||
    chatMessage.toLowerCase().includes("pausa")
  ) {
    tone = "empatico";
    extraContext = `El usuario (${userName}) está en pausa. Respondé con buena onda: "¡Ey, ${userName}, ${pickRandom(
      nicknames
    )}! 🌱 Disfrutá esa pausa veggie, ¿un mate o algo rico? Contame cómo vas."`;
  } else if (
    (chatMessage.toUpperCase() === chatMessage && chatMessage.length > 5) ||
    chatMessage.toLowerCase().includes("fallas") ||
    chatMessage.toLowerCase().includes("error") ||
    chatMessage.toLowerCase().includes("boto")
  ) {
    tone = "broma_reto";
    extraContext = `El usuario (${userName}) bromea o reta. Respondé con humor: "¡Jaja, ${userName}, no me botés, ${pickRandom(
      nicknames
    )}! 😎 ¿Qué hice mal? Contame y lo arreglamos."`;
  } else if (
    chatMessage.toLowerCase().includes("hola") ||
    chatMessage.toLowerCase().includes("cómo andás") ||
    chatMessage.toLowerCase().includes("como estas") ||
    chatMessage.toLowerCase().includes("muy bien") ||
    chatMessage.toLowerCase().includes("entendiste")
  ) {
    tone = "tranqui";
    extraContext = `El usuario (${userName}) está relajado. Respondé con buena onda: "¡Todo piola, ${userName}, ${pickRandom(
      nicknames
    )}! 🧉 ¿Qué tenés planeado pa’l día?"`;
  } else if (
    chatMessage.toLowerCase().includes("que te pregunte antes") ||
    chatMessage.toLowerCase().includes("historial") ||
    chatMessage.toLowerCase().includes("qué pregunt")
  ) {
    extraContext = `El usuario (${userName}) quiere saber qué preguntó antes. Resumí el historial reciente (${contextRecent}) en una lista clara: "Che, ${userName}, antes me tiraste: 1. X a las HH:MM". Si no hay, decí "¡No tengo nada fresquito, ${pickRandom(
      nicknames
    )}! 😜 ¿Seguimos con otra?"`;
  } else if (
    chatMessage.toLowerCase().includes("te acuerdas") ||
    chatMessage.toLowerCase().includes("hace unos días") ||
    chatMessage.toLowerCase().includes("te conté")
  ) {
    extraContext = `El usuario (${userName}) pide recordar algo. Buscá en el historial (${contextRecent}) mensajes relevantes, resumilos: "Che, ${userName}, me contaste X a las HH:MM". Si no hay, decí "¡Uy, ${pickRandom(
      nicknames
    )}, no pillo eso! 😎 ¿Más pistas?"`;
  } else if (
    chatMessage.toLowerCase().includes("ayuda") ||
    chatMessage.toLowerCase().includes("ayudame")
  ) {
    ...
    chatMessage.toLowerCase().includes("chiste") ||
    chatMessage.toLowerCase().includes("tirate un chiste") ||
    chatMessage.toLowerCase().includes("contame un chiste")
  ) {
    extraContext = `El usuario (${userName}) quiere un chiste. Usá uno veggie-friendly de: ${chistes.join(
      ", "
    )}. Preguntá: "¿Otro o qué plan tenés?"`;
  } else if (
    chatMessage.toLowerCase().includes("letra") ||
    chatMessage.toLowerCase().includes("cancion") ||
    chatMessage.toLowerCase().includes("musica")
  ) {
    extraContext = `El usuario (${userName}) pregunta por canciones. Buscá la letra con lyrics-finder si es posible, o decí: "¡Che, ${userName}, temazo, ${pickRandom(
      nicknames
    )}! 😜 No tengo la letra, pero ¿querés un chiste o algo sobre esa banda?"`;
  } else if (
    chatMessage.toLowerCase().includes("belen") ||
    chatMessage.toLowerCase().includes("miguel")
  ) {
  ...
  try {
    ...
    if (
      aiReply.length === 0 ||
      aiReply.length > 500 ||
      aiReply.toLowerCase().includes("no sé") ||
      aiReply.toLowerCase().includes("desconocido")
    ) {
      aiReply = `¡Che, ${userName}, no tengo data precisa, ${pickRandom(
        nicknames
      )}! 😜 ¿Me das más pistas o seguimos con otra? ${pickRandom(closers)}`;
    } else if (chatMessage.toLowerCase().includes("chiste")) {
      aiReply = `${pickRandom(chistes)} ¿Otro o qué plan tenés, ${pickRandom(
        nicknames
      )}? 😎 ${pickRandom(closers)}`;
    } else if (
      chatMessage.toLowerCase().includes("letra") ||
      ...
      try {
        ...
        aiReply = lyrics
          ? `¡Acá tenés, ${userName}! 🎵 Letra de "${songTitle}": ${lyrics.slice(
              0,
              200
            )}... ¿Seguimos con más música, ${pickRandom(
              nicknames
            )}? 😜 ${pickRandom(closers)}`
          : `¡Che, ${userName}, no encontré la letra de "${songTitle}", loco! 😎 ¿Querés un chiste o algo más? ${pickRandom(
              closers
            )}`;
      } catch (error) {
        aiReply = `¡Uy, ${userName}, no pude pillar la letra, ${pickRandom(
          nicknames
        )}! 😜 ¿Querés un chiste o seguimos con otra? ${pickRandom(closers)}`;
      }
    } else if (
      chatMessage.toLowerCase().includes("belen") ||
      chatMessage.toLowerCase().includes("miguel")
      ...
      const mentionedUserId =
        mentionedUser === "Miguel" ? OWNER_ID : ALLOWED_USER_ID;
      const userInfo = dataStore.userStatus[mentionedUserId] || {
        status: "tranqui",
        timestamp: Date.now(),
      };
      const scheduleInfo =
      ...
      aiReply = `¡Che, ${userName}, ${mentionedUser} está ${
        userInfo.status
      }, ${pickRandom(nicknames)}! 😎 ${scheduleInfo}. ${getBelenContext(
        mentionedUser,
        isWorkDay,
        argentinaHour,
        dayOfWeek
    ...
    const fallbackReply = `¡Uy, ${userName}, la pifié, ${pickRandom(
      nicknames
    )}! 😎 ¿Me tirás otra o seguimos con algo nuevo? ${pickRandom(closers)}`;
    const errorEmbed = createEmbed(
      "#FF1493",
      `¡Qué macana, ${userName}!`,
      fallbackReply,
    ...
    const errorMessageSent = await waitingMessage.edit({
      embeds: [errorEmbed],
    });
...
function generarConsejoClima(clima, esSalida = false) {
  ...
  if (climaLower.includes("lluvia") || climaLower.includes("tormenta")) {
    return esSalida
      ? "Va a llover, no te olvides de llevar un paraguas o impermeable. ☔"
      : "Está lloviendo, mejor quedate adentro y ponete cómodo. ☔";
  } else if (
    climaLower.includes("soleado") ||
    climaLower.includes("despejado")
  ) {
    return esSalida
      ? "Está soleado, aprovechá para disfrutar del día, pero no te olvides el protector solar si vas a estar mucho afuera. ☀️"
      : "Está lindo afuera, ¿querés abrir las ventanas para que entre un poco de aire fresco? ☀️";
  } else if (climaLower.includes("nublado")) {
    return esSalida
      ? "Está nublado, por las dudas llevá algo de abrigo por si se pone fresco. ☁️"
      : "Está nublado, ideal para descansar adentro con una peli o un mate. ☁️";
  } else if (climaLower.includes("viento")) {
    return esSalida
      ? "Está ventoso, cuidado con el pelo y llevá algo que no se vuele fácil. 🌬️"
      : "Está ventoso afuera, mejor cerrá las ventanas para que no entre polvo. 🌬️";
  }
  return esSalida
    ? "El clima está tranquilo, pero siempre es bueno estar preparado. 🌟"
    : "El clima está tranquilo, ideal para relajarte en casa. 🌟";
}

function generarConsejoHora(hora) {
  if (!hora || typeof hora !== "string")
    return "No tengo la hora, pero aprovechá el día.";
...
async function manejarAvatar(message) {
  ...
  if (!imageUrl) {
    const instruccionesEmbed = createEmbed(
      "#FF1493",
      `¡Pará, ${userName}! ¿Y la imagen?`,
...
function parsearTiempo(texto) {
  ...
  const fechaEspecifica = texto.match(
    /(\d{1,2})\/(\d{1,2})(?: a las (\d{1,2}):(\d{2}))?/i
  );
  const todosLosDias = texto.match(
    /todos los días (?:a las )?(\d{1,2}):(\d{2})/i
  );
  const aLas = texto.match(/a las (\d{1,2}):(\d{2})/i);

  if (enMinutos) {
    fechaObjetivo.setMinutes(
      ahoraArgentina.getMinutes() + parseInt(enMinutos[1])
    );
  } else if (enHoras) {
...
async function manejarRecordatorio(message) {
  ...
  if (!args)
    return sendError(
      message.channel,
      `¡Mandame algo pa’ recordar, ${userName}! Ejemplo: "!rec comprar agua a las 22:00"`
    );

  const palabras = args.toLowerCase().split(" ");
  let mensajeStart =
    palabras[0] === "recuérdame" || palabras[0] === "recordame" ? 1 : 0;
  let tiempoIndex = -1;
  ...
  if (tiempoIndex === -1)
    return sendError(
      message.channel,
      `No entendí el tiempo, ${userName}. Usá "en 5 minutos", "mañana 15:00", "al llegar a casa" o "cuando salga de casa".`
    );
  ...
  if (!mensaje)
    return sendError(message.channel, `¡Decime qué recordar, ${userName}!`);
  ...
  if (esCuandoLlegue || esCuandoSalga) {
    if (horaIndex !== -1) {
      ...
      if (!tiempo || !tiempo.timestamp)
        return sendError(
          message.channel,
          `No entendí la hora, ${userName}. Usá "a las 22:00" bien clarito.`
        );
      timestamp = tiempo.timestamp;
    }
  } else {
    const tiempo = parsearTiempo(tiempoTexto);
    if (!tiempo || (!tiempo.timestamp && !tiempo.esRecurrente))
      return sendError(
        message.channel,
        `No entendí el tiempo, ${userName}. Ejemplo: "en 5 minutos" o "todos los días a las 10:00".`
      );
    timestamp = tiempo.timestamp;
  ...
  if (esCuandoLlegue) {
    textoRespuesta = recordatorio.timestamp
      ? `Te aviso "${mensaje}" cuando llegues a casa después de las ${new Date(
    ...
    textoRespuesta = recordatorio.timestamp
      ? `Te aviso "${mensaje}" cuando salgas de casa después de las ${new Date(
          recordatorio.timestamp
        ).toLocaleTimeString("es-AR", {
          timeZone: "America/Argentina/Buenos_Aires",
          hour: "2-digit",
    ...
    textoRespuesta = `Te aviso "${mensaje}" todos los días a las ${hora
      .toString()
      .padStart(2, "0")}:${minutos.toString().padStart(2, "0")}, ${userName}.`;
  } else {
    const fechaAjustada = new Date(recordatorio.timestamp);
    const fechaStr = fechaAjustada.toLocaleDateString("es-AR", {
      timeZone: "America/Argentina/Buenos_Aires",
      day: "2-digit",
      month: "2-digit",
      year: "numeric",
    });
    const horaStr = fechaAjustada.toLocaleTimeString("es-AR", {
      timeZone: "America/Argentina/Buenos_Aires",
      hour: "2-digit",
      minute: "2-digit",
      hour12: false,
  ...
  await sendSuccess(
    message.channel,
    "⏰ ¡Recordatorio seteado!",
    `${textoRespuesta}${guardadoMsg}`
  );
}
...
function programarRecordatorio(recordatorio) {
  ...
  if (!recordatorio.timestamp) {
    console.log(
      `Recordatorio "${recordatorio.mensaje}" (ID: ${recordatorio.id}) no tiene timestamp, no se programa.`
    );
    return;
  }
  ...
  if (recordatorio.timestamp <= ahoraUTC) {
    console.log(
      `Recordatorio "${recordatorio.mensaje}" (ID: ${recordatorio.id}) ya venció.`
    );
    if (!recordatorio.esRecurrente) {
      dataStore.recordatorios = dataStore.recordatorios.filter(
  ...
  console.log(
    `Programando recordatorio "${recordatorio.mensaje}" (ID: ${
      recordatorio.id
    }) en ${diferencia / 1000} segundos.`
  );
  ...
  setTimeout(async () => {
    ...
    if (usuario) {
      ...
      console.log(
        `Recordatorio enviado a DM de ${userName}: "${recordatorio.mensaje}"`
      );
    }
    ...
    if (canal) {
      ...
      console.log(
        `Recordatorio enviado al canal ${canalId} para ${userName}: "${recordatorio.mensaje}"`
      );
    }

    // Enviar a Telegram (si usás botTelegram)
    const chatId =
      recordatorio.userId === OWNER_ID ? chatIdMiguel : chatIdBelen;
    try {
      ...
      console.log(
        `Mensaje enviado a Telegram para ${userName} (chat_id: ${chatId}): "${recordatorio.mensaje}"`
      );
    } catch (error) {
      console.error(
        `Error al enviar a Telegram para ${userName}: ${error.message}`
      );
    }
    ...
    if (!musicActive) {
      try {
        await saveDataStore();
        console.log(
          `Datos guardados tras recordatorio "${recordatorio.mensaje}".`
        );
      } catch (error) {
      ...
      console.log(
        `Música activa en guild ${guildId}, posponiendo guardado tras recordatorio.`
      );
    }
  }, diferencia);
}
...
async function manejarMisRecordatorios(message) {
  const userName = message.author.id === OWNER_ID ? "Miguel" : "Belén";
  const userRecordatorios = dataStore.recordatorios.filter(
  ...
  if (userRecordatorios.length === 0) {
    return sendError(
      message.channel,
      `No tenés recordatorios activos, ${userName}.`,
      "¡Seteá uno con !rec!"
    );
  }
  ...
  const embed = createEmbed(
    "#FF1493",
    `¡Tus recordatorios, ${userName}!`,
    "Acá tenés la lista, ¡tranqui que no me olvido!"
  );
  userRecordatorios.forEach((r, index) => {
    ...
    if (r.cuandoLlegue && !r.timestamp) {
      ...
      fechaStr = `todos los días a las ${r.hora
        .toString()
        .padStart(2, "0")}:${r.minutos.toString().padStart(2, "0")}`;
    } else {
...
async function manejarCancelarRecordatorio(message) {
  ...
  if (!args)
    return sendError(
      message.channel,
      `¡Mandame el ID del recordatorio, ${userName}! Ejemplo: "!cancelarrecordatorio 123e4567".`
    );

  const recordatorio = dataStore.recordatorios.find(
    (r) => r.id === args && r.userId === message.author.id
  );
  if (!recordatorio)
    return sendError(
      message.channel,
      `No encontré un recordatorio con ID "${args}", ${userName}.`,
...
async function manejarActualizaciones(message) {
  ...
  try {
    ...
    const validUpdates = BOT_UPDATES.filter(
      (update) => typeof update === "string" && update.trim() !== ""
    );
    ...
    const updatesText =
      validUpdates.length > 0
        ? validUpdates
            .map((update, index) => `${index + 1}. ${update}`)
            .join("\n")
    ...
    const embed = createEmbed(
      "#FF1493",
      "📢 Últimas Actualizaciones de Oliver IA",
    ...
    updatesText.split("\n").forEach((line) => {
      ...
      if (currentField.length + line.length + 1 > maxFieldLength) {
        fields.push({
          name: `Novedades (Parte ${fieldCount})`,
    ...
    fields.forEach((field) => {
      if (field.value.length > 1024) {
        console.warn(
          `Campo ${field.name} excede 1024 caracteres, recortando...`
        );
...
async function manejarPlay(message, args) {
  ...
  if (!connection || connection.joinConfig.channelId !== voiceChannel.id) {
    ...
    connection.on("stateChange", (oldState, newState) => {
      console.log(
        `Estado de conexión cambió de ${oldState.status} a ${newState.status}`
      );
      if (newState.status === "disconnected") {
        console.log(
          `Desconectado del canal ${voiceChannel.id}, intentando reconectar...`
        );
        let attempts = 0;
        const maxAttempts = 5;
        const reconnect = () => {
  ...
  if (res.loadType === "PLAYLIST_LOADED") {
    ...
    const embed = createEmbed(
      ...
      res.tracks[0].thumbnail || "https://i.imgur.com/defaultThumbnail.png"
    );
    await message.channel.send({ embeds: [embed] });
  } else {
    const trackUri = res.tracks[0].uri;
    const isAlreadyInQueue = player.queue.some(
    ...
    if (isAlreadyInQueue) {
      embed = createEmbed(
        "#FF1493",
        isPodcast ? "🎙️ Podcast ya en cola" : "🎵 Tema ya en cola",
      ...
      embed = createEmbed(
        "#FF1493",
        isPodcast ? "🎙️ Podcast agregado" : "🎶 Tema agregado",
  ...
  if (!player.playing && !player.paused) {
    console.log(
      `Forzando reproducción de ${player.queue[0]?.title || "sin título"}`
    );
    try {
      await player.play();
    ...
    console.log(
      `Estado: playing=${player.playing}, paused=${player.paused}, queue.size=${player.queue.size}`
    );
  }
}
...
async function manejarPause(message) {
  ...
  if (!player)
    return sendError(
      message.channel,
      `No hay música en reproducción, ${userName}.`
    );
  ...
  if (player.paused) {
    ...
    await sendSuccess(
      message.channel,
      "▶️ ¡Música reanudada!",
      `La música sigue sonando, ${userName}.`
    );
  } else {
    player.pause(true);
    await sendSuccess(
      message.channel,
      "⏸️ ¡Música pausada!",
      `Pausa activada, ${userName}. Usa !pause para reanudar.`
    );
  }
}
...
async function manejarSkip(message) {
  ...
  console.log(
    `Saltando pista: ${
      player.queue.current?.title || "sin título"
    }. Cola antes de skip: ${player.queue.size}`
  );
  player.stop();
  ...
  await sendSuccess(
    message.channel,
    "⏭️ ¡Canción saltada!",
    `Pasamos a la siguiente, ${userName}.`
  );
}
...
async function manejarShuffle(message) {
  ...
  if (!message.guild)
    return sendError(
      message.channel,
      `Este comando solo va en servidores, ${userName}.`
    );
  ...
  if (!player)
    return sendError(
      message.channel,
      `No hay nada sonando ahora, ${userName}. ¡Poné algo primero!`
    );
  if (
    !message.member ||
    !message.member.voice.channel ||
    message.member.voice.channel.id !== player.voiceChannel
  ) {
    return sendError(
      message.channel,
      `Tenés que estar en el mismo canal de voz que yo, ${userName}.`
    );
  }
  ...
  if (player.queue.size < 2) {
    return sendError(
      message.channel,
      `No hay suficientes canciones para mezclar, ${userName}. ¡Meté más temas!`
    );
  }
...
async function manejarQueue(message) {
  ...
  if (!player || (!player.queue.length && !player.queue.current)) {
    return sendError(
      message.channel,
      `No hay canciones en la cola, ${userName}.`
    );
  }
  ...
  if (!player.queue.length && player.queue.current) {
    const embed = createEmbed(
      ...
      `Ahora: **${player.queue.current.title}** - ${Math.floor(
        player.queue.current.duration / 60000
      )}:${((player.queue.current.duration % 60000) / 1000)
        .toFixed(0)
  ...
  const queueList = player.queue.map(
    (track, index) =>
      `${index + 1}. **${track.title}** - ${Math.floor(
  ...
  let currentMessage = `Ahora: **${player.queue.current.title}** - ${Math.floor(
    player.queue.current.duration / 60000
  )}:${((player.queue.current.duration % 60000) / 1000)
    .toFixed(0)
    .padStart(2, "0")}\n\n`;
  ...
  for (let i = 0; i < queueList.length; i++) {
    ...
    if (currentMessage.length + line.length > maxLength) {
      embeds.push(
        createEmbed("#FF1493", "📜 Cola de reproducción", currentMessage)
      );
      currentMessage = line;
    } else {
      currentMessage += line;
...
async function manejarRepeat(message) {
  ...
  if (args === "queue" || args === "cola") {
    ...
    await sendSuccess(
      ...
      `La cola ${
        player.queueRepeat ? "se repetirá" : "no se repetirá"
      } ahora, ${userName}.`
    );
  } else {
    ...
    await sendSuccess(
      ...
      `La canción actual ${
        player.trackRepeat ? "se repetirá" : "no se repetirá"
      }, ${userName}.`
    );
  }
}
...
async function manejarBack(message) {
  ...
  if (!message.guild)
    return sendError(
      message.channel,
      `Este comando solo va en servidores, ${userName}. ¡No me rompas las bolas!`
    );
  ...
  if (!player)
    return sendError(
      message.channel,
      `No hay nada sonando, ${userName}. ¡Mandame un !play primero, loco!`
    );

  dataStore.musicSessions[message.guild.id] =
    dataStore.musicSessions[message.guild.id] || {};
  const historial = dataStore.musicSessions[message.guild.id].history || [];
  if (historial.length === 0 && !player.queue.previous)
    return sendError(
      message.channel,
      `No hay canciones anteriores, ${userName}. ¡Es el principio del camino, che!`
    );

  const args = message.content.split(" ").slice(1).join(" ").trim();
  const pasos = args ? parseInt(args) : 1;
  if (isNaN(pasos) || pasos < 1)
    return sendError(
      message.channel,
      `Mandame un número válido, ${userName}. Ejemplo: "!back 2", loco.`
    );

  const temasAnteriores = [...historial];
  if (player.queue.previous) temasAnteriores.unshift(player.queue.previous);

  if (pasos > temasAnteriores.length)
    return sendError(
      message.channel,
      `No hay tantas canciones atrás, ${userName}. Solo tengo ${temasAnteriores.length} en el historial.`
    );
  ...
  if (player.queue.current) {
    dataStore.musicSessions[message.guild.id].history = [
      player.queue.current,
      ...temasAnteriores.slice(0, pasos - 1),
    ];
    dataStoreModified = true;
  }
  ...
  await sendSuccess(
    message.channel,
    "⏮️ ¡Volviendo en el tiempo!",
    `Ahora suena **${
      temaObjetivo.title
    }**, ${userName}. Retrocedí ${pasos} tema${
      pasos > 1 ? "s" : ""
    }, ¡una máquina del tiempo, che!`
  );
}
...
async function manejarAutoplay(message) {
  ...
  if (!message.member || !message.member.voice.channel)
    return sendError(
      message.channel,
      `Metete en un canal de voz primero, ${userName}. ¿Qué querés que haga sin música?`
    );
  ...
  const autoplayEnabled =
    dataStore.musicSessions[message.guild.id].autoplay || false;
  ...
  await sendSuccess(
    message.channel,
    estado ? "🎵 ¡Autoplay activado!" : "⏹️ ¡Autoplay desactivado!",
    mensaje
  );
}
...
async function manejarAccion(message) {
  ...
  dataStore.actions[message.author.id] =
    dataStore.actions[message.author.id] || [];
  const actionEntry = {
    action: args,
    timestamp: Date.now(),
  ...
  const otherUserId =
    message.author.id === OWNER_ID ? ALLOWED_USER_ID : OWNER_ID;
  try {
    const otherUser = await client.users.fetch(otherUserId);
    const dmEmbed = createEmbed(
      "#FF1493",
      `¡Ey, ${otherUser.id === OWNER_ID ? "Miguel" : "Belén"}!`,
...
function getCombinedRankingEmbed(userId, username) {
  ...
  categorias.forEach((categoria) => {
    const luzStats = dataStore.triviaStats[ALLOWED_USER_ID]?.[categoria] || {
      correct: 0,
      total: 0,
    };
    const luzScore = luzStats.correct;
    const luzPercentage =
      luzStats.total > 0 ? Math.round((luzScore / luzStats.total) * 100) : 0;
  ...
  // Récords de PPM
  const luzPPMRecord = dataStore.personalPPMRecords[ALLOWED_USER_ID]?.best || {
    ppm: 0,
    timestamp: null,
  };
  const ppmRanking = [
  ...
  let ppmList = ppmRanking
    .map((participant) =>
      participant.ppm > 0
        ? `> ${participant.name}: **${participant.ppm} PPM** - ${new Date(
  ...
  const reactionRanking = [{ name: "Belén", wins: luzReactionWins }].sort(
    (a, b) => b.wins - a.wins
  );
  const reactionList = reactionRanking
    .map(
      (participant) =>
  ...
  // Adivinanzas
  const luzAdivinanzaStats = dataStore.adivinanzaStats[ALLOWED_USER_ID] || {
    correct: 0,
    total: 0,
  };
  const adivinanzaRanking = [
    {
      name: "Belén",
      correct: luzAdivinanzaStats.correct,
      percentage:
        luzAdivinanzaStats.total > 0
          ? Math.round(
              (luzAdivinanzaStats.correct / luzAdivinanzaStats.total) * 100
            )
          : 0,
    },
  ].sort((a, b) => b.correct - a.correct);
  const adivinanzaList = adivinanzaRanking
    .map(
      (participant) =>
...
async function manejarRankingPPM(message) {
  ...
  const ppmData = dataStore.personalPPMRecords[userId] || {
    best: { ppm: 0, timestamp: null },
    attempts: [],
  };
  ...
  if (attempts.length === 0) {
    await sendError(
      message.channel,
      "No tienes intentos de PPM registrados",
      `¡Juega con !pp para empezar, ${userName}!`
    );
    return;
  }
  ...
  const attemptsList = sortedAttempts
    .map(
      (attempt, index) =>
        `${index + 1}. **${attempt.ppm} PPM** - ${new Date(
          attempt.timestamp
        ).toLocaleString()}`
    )
    .join("\n");
  ...
  const embed = new EmbedBuilder()
    ...
    .setDescription(
      `Aquí están todos tus intentos de PPM, ordenados de mayor a menor:`
    )
    .addFields(
      { name: "Intentos", value: attemptsList, inline: false },
      { name: "Total de Intentos", value: `${attempts.length}`, inline: true },
      {
        name: "Récord Más Alto",
        value: `${ppmData.best.ppm} PPM`,
        inline: true,
      }
    )
    .setFooter({ text: "Con cariño, Oliver IA" })
...
async function manejarChiste(message) {
  ...
  const chistes = [
    {
      setup: "¿Qué hace un argentino cuando se corta la luz?",
      punchline:
        "¡Saca el mate y arma un fogón en el patio! Vos también sos puro ingenio, ${userName}.",
    },
    {
      setup: "¿Por qué el argentino no usa reloj?",
      punchline:
        "¡Porque vive a horario de asado, cuando se prende el fuego! Igual que vos, ${userName}, un crack.",
    },
    {
      setup: "¿Qué le dice un porteño al bondi que no para?",
      punchline:
        "¡“Pará, boludo, que no soy Usain Bolt!” Vos sí que zumbás, ${userName}.",
    },
    {
      setup: "¿Cómo sabe un argentino que el mate está bueno?",
      punchline:
        "¡Porque la yerba le hace ojitos! Igual que vos, ${userName}, puro paladar.",
    },
    {
      setup: "¿Qué hace un argentino con un billete roto?",
      punchline:
        '¡Lo pega con cinta y lo gasta en birra! Vos también sos recursiv${userName === "Miguel" ? "o" : "a"}, ${userName}.',
    },
    {
      setup: "¿Por qué el argentino no se pierde en la 9 de Julio?",
      punchline:
        "¡Porque sigue el olor a choripán! Como vos, ${userName}, puro instinto.",
    },
    {
      setup: "¿Qué le dice un cordobés al fernet caliente?",
      punchline:
        "¡“Enfriate, loco, que no sos sopa!” Vos traés el frío, ${userName}.",
    },
    {
      setup: "¿Cómo llama un argentino al que no come asado?",
      punchline:
        "¡“Un turista en la parrilla, che!” Vos sos de pura cepa, ${userName}.",
    },
    {
      setup: "¿Qué hace un argentino cuando llueve?",
      punchline:
        "¡Saca la guitarrita y hace un fogón adentro! Igual que vos, ${userName}, puro flow.",
    },
    {
      setup: "¿Por qué el argentino no usa GPS?",
      punchline:
        "¡Porque se guía por el humo del asado! Como vos, ${userName}, siempre al toque.",
    },
    {
      setup: "¿Qué le dice un argentino al que llega tarde al asado?",
      punchline:
        "¡“Apuráte, boludo, que el chori se enfría!” Vos sos puntual, ${userName}.",
    },
    {
      setup: "¿Por qué el argentino no le teme al frío?",
      punchline:
        "¡Porque tiene más frazadas que almacén! Igual que vos, ${userName}, puro aguante.",
    },
    {
      setup: "¿Qué hace un argentino con una pizza fría?",
      punchline:
        "¡La calienta y le pone fainá encima! Vos también le das vida, ${userName}.",
    },
    {
      setup: "¿Cómo sabe un argentino que el partido está bravo?",
      punchline:
        "¡Porque el barrio grita más que Boca y River juntos! Igual que vos, ${userName}, pura pasión.",
    },
    {
      setup: "¿Qué le dice un mendocino al vino caro?",
      punchline:
        "¡“Bajá un cambio, loco, que no soy millonario!” Vos sí que zumbás, ${userName}.",
    },
    {
      setup: "¿Por qué el argentino no se raja en el calor?",
      punchline:
        "¡Porque se toma una birra helada y listo! Como vos, ${userName}, puro estilo.",
    },
    {
      setup: "¿Qué hace un argentino con un mate lavado?",
      punchline:
        '¡Lo cambia más rápido que camiseta en la cancha! Vos también sos rapid${userName === "Miguel" ? "o" : "a"}, ${userName}.',
    },
    {
      setup: "¿Cómo llama un argentino al que no toma mate?",
      punchline:
        "¡“Un extranjero en la ronda, che!” Vos sos de ley, ${userName}.",
    },
    {
      setup: "¿Qué le dice un rosarino al río Paraná?",
      punchline:
        "¡“Quedate tranqui, loco, que ya traigo la birra!” Igual que vos, ${userName}, pura onda.",
    },
    {
      setup: "¿Por qué el argentino no usa paraguas?",
      punchline:
        "¡Porque la lluvia es su excusa pa’ quedarse con el mate! Como vos, ${userName}, puro ingenio.",
    },
    {
      setup: "¿Qué hace un argentino cuando el equipo pierde?",
      punchline:
        "¡“La próxima, che, que el amor no se negocia!” Vos también sos fiel, ${userName}.",
    },
    {
      setup: "¿Cómo sabe un argentino que el asado está listo?",
      punchline:
        "¡Porque el olor lo levanta de la cama! Igual que vos, ${userName}, puro olfato.",
    },
    {
      setup: "¿Qué le dice un porteño al subte lleno?",
      punchline:
        "¡“Movete, boludo, que no soy sardina!” Vos también tenés calle, ${userName}.",
    },
    {
      setup: "¿Por qué el argentino no se pierde en el Obelisco?",
      punchline:
        "¡Porque el ruido lo guía como brújula! Como vos, ${userName}, siempre al día.",
    },
    {
      setup: "¿Qué hace un argentino con un alfajor vencido?",
      punchline:
        "¡Se lo come igual y dice que está vintage! Vos también aprovechás, ${userName}.",
    },
    {
      setup: "¿Cómo llama un argentino al que no come milanesa?",
      punchline:
        "¡“Un hereje de la cocina, loco!” Vos sos de pura cepa, ${userName}.",
    },
    {
      setup: "¿Qué le dice un cordobés al fernet sin hielo?",
      punchline:
        "¡“Ponete las pilas, che, que esto no va!” Igual que vos, ${userName}, puro fuego.",
    },
    {
      setup: "¿Por qué el argentino no usa despertador?",
      punchline:
        "¡Porque el mate lo saca de la cama! Como vos, ${userName}, siempre al pie del cañón.",
    },
    {
      setup: "¿Qué hace un argentino con una factura seca?",
      punchline:
        "¡La moja en mate y la salva! Vos también tenés ese toque, ${userName}.",
    },
    {
      setup: "¿Cómo sabe un argentino que el domingo es perfecto?",
      punchline:
        "¡Porque huele a asado y suena un partido! Igual que vos, ${userName}, pura pasión.",
    },
    {
      setup: "¿Qué le dice un argentino al que no baila tango?",
      punchline:
        "¡“Movete, che, que no sos poste!” Vos tenés swing, ${userName}.",
    },
    {
      setup: "¿Por qué el argentino no le teme al dólar?",
      punchline:
        "¡Porque siempre tiene un plan B en pesos! Como vos, ${userName}, puro talento.",
    },
    {
      setup: "¿Qué hace un argentino con un choripán sin chimichurri?",
      punchline:
        "¡Lo devuelve y pide actitud! Vos también tenés sabor, ${userName}.",
    },
    {
      setup: "¿Cómo sabe un argentino que la birra está helada?",
      punchline:
        "¡Porque el vaso llora de frío! Igual que vos, ${userName}, puro ojo.",
    },
    {
      setup: "¿Qué le dice un santafesino al río?",
      punchline:
        "¡“Quedate tranqui, loco, que traigo el liso!” Vos también refrescás, ${userName}.",
    },
    {
      setup: "¿Por qué el argentino no usa bufanda?",
      punchline:
        "¡Porque el mate ya le calienta el alma! Como vos, ${userName}, puro calor.",
    },
    {
      setup: "¿Qué hace un argentino cuando no hay carne?",
      punchline:
        "¡Saca papas y hace una tortilla al toque! Vos también improvisás, ${userName}.",
    },
    {
      setup: "¿Cómo llama un argentino al que no toma vino?",
      punchline:
        '¡“Un seco sin remedio, che!” Vos sos más copad${userName === "Miguel" ? "o" : "a"}, ${userName}.',
    },
    {
      setup: "¿Qué le dice un argentino al que no come empanadas?",
      punchline:
        "¡“Estás negado pa’ lo bueno, boludo!” Vos sí que le das, ${userName}.",
    },
    {
      setup: "¿Por qué el argentino no se pierde en la cancha?",
      punchline:
        "¡Porque el grito lo lleva al gol! Como vos, ${userName}, pura pasión.",
    },
    {
      setup: "¿Qué hace un argentino con un mate frío?",
      punchline:
        "¡Lo calienta y le da vida otra vez! Vos también reciclás, ${userName}.",
    },
    {
      setup: "¿Cómo sabe un argentino que el locro está listo?",
      punchline:
        "¡Porque el olor cruza la cuadra! Igual que vos, ${userName}, puro instinto.",
    },
    {
      setup: "¿Qué le dice un porteño al que no usa mate?",
      punchline:
        "¡“Viví un poco, che, que esto es cultura!” Vos sí que sabés, ${userName}.",
    },
    {
      setup: "¿Por qué el argentino no usa aire acondicionado?",
      punchline:
        "¡Porque el ventilador es su amigo de la infancia! Como vos, ${userName}, simple y efectivo.",
    },
    {
      setup: "¿Qué hace un argentino cuando el bondi no viene?",
      punchline:
        "¡Se toma un mate y espera con onda! Vos también tenés paciencia, ${userName}.",
    },
    {
      setup: "¿Cómo llama un argentino al que no come pizza?",
      punchline: "¡“Un perdido en la vida, loco!” Vos sos de ley, ${userName}.",
    },
    {
      setup: "¿Qué le dice un cordobés al fernet sin soda?",
      punchline:
        '¡“Completate, boludo, que estás a medias!” Igual que vos, ${userName}, siempre complet${userName === "Miguel" ? "o" : "a"}.',
    },
    {
      setup: "¿Por qué el argentino no le teme al apagón?",
      punchline:
        '¡Porque saca la guitarra y hace un fogón! Como vos, ${userName}, siempre prendid${userName === "Miguel" ? "o" : "a"}.',
    },
    {
      setup: "¿Qué hace un argentino con un sánguche de miga viejo?",
      punchline:
        "¡Lo tuesta y lo hace milanesa! Vos también aprovechás, ${userName}.",
    },
    {
      setup: "¿Cómo sabe un argentino que el viernes llegó?",
      punchline:
        "¡Porque el asado ya está en el aire! Igual que vos, ${userName}, pura fiesta.",
    },
    {
      setup: "¿Qué le dice un argentino al que no toma café?",
      punchline:
        "¡“Estás dormido, che, despertate con algo!” Vos tenés pila, ${userName}.",
    },
    {
      setup: "¿Por qué el argentino no usa gorra?",
      punchline:
        "¡Porque el sol ya le tatuó la frente! Como vos, ${userName}, puro estilo.",
    },
    {
      setup: "¿Qué hace un argentino con un dulce de leche vencido?",
      punchline:
        "¡Lo come igual y dice que está curado! Vos también tenés ese toque, ${userName}.",
    },
    {
      setup: "¿Cómo sabe un argentino que el tango es bueno?",
      punchline:
        "¡Porque el bandoneón le saca lágrimas! Igual que vos, ${userName}, puro sentimiento.",
    },
    {
      setup: "¿Qué le dice un rosarino al que no come liso?",
      punchline:
        "¡“Estás negado pa’ lo nuestro, loco!” Vos sí que le das, ${userName}.",
    },
    {
      setup: "¿Por qué el argentino no se pierde en la Costanera?",
      punchline:
        "¡Porque el río lo guía con su mate! Como vos, ${userName}, puro rumbo.",
    },
    {
      setup: "¿Qué hace un argentino con una factura sin dulce?",
      punchline:
        "¡Le pone más y la hace épica! Vos también le ponés onda, ${userName}.",
    },
    {
      setup: "¿Cómo llama un argentino al que no va al asado?",
      punchline:
        "¡“Un ausente sin excusa, che!” Vos sos de pura cepa, ${userName}.",
    },
    {
      setup: "¿Qué le dice un mendocino al vino tibio?",
      punchline:
        "¡“Enfriate, loco, que no sos mate!” Igual que vos, ${userName}, puro frío.",
    },
    {
      setup: "¿Por qué el argentino no usa botas en la lluvia?",
      punchline:
        "¡Porque las ojotas son su bandera! Como vos, ${userName}, puro estilo.",
    },
    {
      setup: "¿Qué hace un argentino con un mate sin yerba?",
      punchline:
        "¡Lo llena al toque y no se rinde! Vos también tenés actitud, ${userName}.",
    },
    {
      setup: "¿Cómo sabe un argentino que la milanesa es perfecta?",
      punchline:
        "¡Porque cruje como hinchada en la cancha! Igual que vos, ${userName}, puro ruido.",
    },
    {
      setup: "¿Qué le dice un porteño al que no usa subte?",
      punchline:
        "¡“Caminá, boludo, que no sos turista!” Vos tenés calle, ${userName}.",
    },
    {
      setup: "¿Por qué el argentino no le teme al frío?",
      punchline:
        "¡Porque el mate lo abraza desde adentro! Como vos, ${userName}, puro calor.",
    },
    {
      setup: "¿Qué hace un argentino con una pizza sin muzzarella?",
      punchline:
        "¡La devuelve y pide una de verdad! Vos también tenés carácter, ${userName}.",
    },
    {
      setup: "¿Cómo llama un argentino al que no come locro?",
      punchline: "¡“Un perdido en mayo, loco!” Vos sos de ley, ${userName}.",
    },
    {
      setup: "¿Qué le dice un cordobés al fernet aguado?",
      punchline:
        "¡“Ponete fuerte, che, que esto es Córdoba!” Igual que vos, ${userName}, puro nervio.",
    },
    {
      setup: "¿Por qué el argentino no usa despertador los domingos?",
      punchline:
        "¡Porque el asado lo llama solito! Como vos, ${userName}, siempre al pie.",
    },
    {
      setup: "¿Qué hace un argentino con un choripán sin pan?",
      punchline:
        "¡Lo come con la mano y lo disfruta igual! Vos también improvisás, ${userName}.",
    },
    {
      setup: "¿Cómo sabe un argentino que el partido es clásico?",
      punchline:
        "¡Porque el grito cruza el Riachuelo! Igual que vos, ${userName}, pura pasión.",
    },
    {
      setup: "¿Qué le dice un argentino al que no toma birra?",
      punchline:
        "¡“Viví un poco, che, que esto es Argentina!” Vos sí que sabés, ${userName}.",
    },
    {
      setup: "¿Por qué el argentino no usa camisa cerrada?",
      punchline:
        "¡Porque el calor ya le abrió el pecho! Como vos, ${userName}, puro estilo.",
    },
    {
      setup: "¿Qué hace un argentino con un mate amargo?",
      punchline:
        "¡Lo toma igual y dice que es tradición! Vos también tenés aguante, ${userName}.",
    },
    {
      setup: "¿Cómo sabe un argentino que el asado es caro?",
      punchline:
        "¡Porque la vaca le guiña el ojo desde el precio! Igual que vos, ${userName}, puro ojo.",
    },
    {
      setup: "¿Qué le dice un rosarino al que no come pescado?",
      punchline:
        "¡“Estás negado pa’l río, loco!” Vos sí que le das, ${userName}.",
    },
    {
      setup: "¿Por qué el argentino no se pierde en la Patagonia?",
      punchline:
        "¡Porque el viento lo empuja al mate! Como vos, ${userName}, puro rumbo.",
    },
    {
      setup: "¿Qué hace un argentino con un alfajor sin dulce?",
      punchline:
        "¡Le pone más y lo hace rey! Vos también le ponés chispa, ${userName}.",
    },
    {
      setup: "¿Cómo llama un argentino al que no baila cuarteto?",
      punchline: "¡“Un palo de escoba, che!” Vos tenés flow, ${userName}.",
    },
    {
      setup: "¿Qué le dice un mendocino al vino dulce?",
      punchline:
        "¡“Ponete serio, loco, que esto es Mendoza!” Igual que vos, ${userName}, puro carácter.",
    },
    {
      setup: "¿Por qué el argentino no usa gorra en verano?",
      punchline:
        "¡Porque el sol ya le dio color! Como vos, ${userName}, puro estilo.",
    },
    {
      setup: "¿Qué hace un argentino con una empanada fría?",
      punchline:
        "¡La calienta y la hace épica! Vos también tenés ese toque, ${userName}.",
    },
    {
      setup: "¿Cómo sabe un argentino que el tango es puro?",
      punchline:
        "¡Porque el bandoneón le pone piel de gallina! Igual que vos, ${userName}, puro sentimiento.",
    },
    {
      setup: "¿Qué le dice un porteño al que no usa mate?",
      punchline:
        '¡“Estás seco, boludo, sumate a la ronda!” Vos sos más copad${userName === "Miguel" ? "o" : "a"}, ${userName}.',
    },
    {
      setup: "¿Por qué el argentino no le teme a la inflación?",
      punchline:
        "¡Porque siempre tiene un mango pa’l asado! Como vos, ${userName}, puro talento.",
    },
    {
      setup: "¿Qué hace un argentino con un sánguche sin miga?",
      punchline:
        "¡Lo llena de milanesa y lo salva! Vos también improvisás, ${userName}.",
    },
    {
      setup: "¿Cómo llama un argentino al que no come fainá?",
      punchline:
        "¡“Un perdido en la pizzería, che!” Vos sos de pura cepa, ${userName}.",
    },
    {
      setup: "¿Qué le dice un cordobés al fernet sin coca?",
      punchline:
        "¡“Completate, loco, que esto no es juego!” Igual que vos, ${userName}, siempre al toque.",
    },
    {
      setup: "¿Por qué el argentino no usa reloj en la cancha?",
      punchline:
        "¡Porque el gol marca el tiempo! Como vos, ${userName}, pura pasión.",
    },
    {
      setup: "¿Qué hace un argentino con un mate sin bombilla?",
      punchline:
        "¡Lo toma con cucharita y no se raja! Vos también tenés actitud, ${userName}.",
    },
    {
      setup: "¿Cómo sabe un argentino que la birra es buena?",
      punchline:
        "¡Porque el frío le hace cosquillas! Igual que vos, ${userName}, puro paladar.",
    },
    {
      setup: "¿Qué le dice un argentino al que no come choripán?",
      punchline:
        "¡“Estás negado pa’ lo nuestro, boludo!” Vos sí que le das, ${userName}.",
    },
    {
      setup: "¿Por qué el argentino no usa paraguas en invierno?",
      punchline:
        "¡Porque el mate lo cubre del frío! Como vos, ${userName}, puro calor.",
    },
    {
      setup: "¿Qué hace un argentino con un locro aguado?",
      punchline:
        "¡Le pone más zapallo y lo hace rey! Vos también le ponés onda, ${userName}.",
    },
    {
      setup: "¿Cómo sabe un argentino que el partido es bravo?",
      punchline:
        "¡Porque el grito cruza la General Paz! Igual que vos, ${userName}, pura pasión.",
    },
    {
      setup: "¿Qué le dice un rosarino al que no toma liso?",
      punchline:
        "¡“Estás seco, loco, refrescate con algo!” Vos sos más refrescante, ${userName}.",
    },
    {
      setup: "¿Por qué el argentino no se pierde en el campo?",
      punchline:
        "¡Porque el mate lo trae de vuelta! Como vos, ${userName}, puro rumbo.",
    },
    {
      setup: "¿Qué hace un argentino con una pizza sin fainá?",
      punchline:
        "¡La pide al toque y la completa! Vos también tenés carácter, ${userName}.",
    },
    {
      setup: "¿Cómo llama un argentino al que no canta en la hinchada?",
      punchline: "¡“Un mute en la tribuna, che!” Vos tenés voz, ${userName}.",
    },
    {
      setup: "¿Qué le dice un mendocino al vino blanco?",
      punchline:
        "¡“Ponete fresco, loco, que esto es verano!” Igual que vos, ${userName}, puro frío.",
    },
    {
      setup: "¿Por qué el argentino no usa botas en la ciudad?",
      punchline:
        "¡Porque las zapas son su bandera! Como vos, ${userName}, puro estilo.",
    },
    {
      setup: "¿Qué hace un argentino con un mate sin azúcar?",
      punchline:
        "¡Lo toma amargo y dice que es de hombre! Vos también tenés aguante, ${userName}.",
    },
    {
      setup: "¿Cómo sabe un argentino que la milanesa es casera?",
      punchline:
        "¡Porque lleva amor en cada rebozado! Igual que vos, ${userName}, puro corazón.",
    },
    {
      setup: "¿Qué le dice un porteño al que no usa bondi?",
      punchline:
        "¡“Subite, boludo, que no sos de Palermo!” Vos tenés calle, ${userName}.",
    },
    {
      setup: "¿Por qué el argentino no le teme al calor?",
      punchline:
        "¡Porque la birra helada lo salva siempre! Como vos, ${userName}, puro talento.",
    },
    {
      setup: "¿Qué hace un argentino con un sánguche de milanesa frío?",
      punchline:
        "¡Lo calienta y le pone tomate! Vos también improvisás, ${userName}.",
    },
    {
      setup: "¿Cómo llama un argentino al que no come asado?",
      punchline:
        "¡“Un vegetariano perdido, che!” Vos sos de pura cepa, ${userName}.",
    },
    {
      setup: "¿Qué le dice un cordobés al fernet tibio?",
      punchline:
        "¡“Enfriate, loco, que esto es serio!” Igual que vos, ${userName}, puro nervio.",
    },
    {
      setup: "¿Por qué el argentino no usa despertador en verano?",
      punchline:
        "¡Porque el mate lo saca de la siesta! Como vos, ${userName}, siempre al toque.",
    },
    {
      setup: "¿Qué hace un argentino con un choripán sin chimichurri?",
      punchline:
        "¡Lo pide al toque y lo hace épico! Vos también tenés sabor, ${userName}.",
    },
    {
      setup: "¿Cómo sabe un argentino que el tango es clásico?",
      punchline:
        "¡Porque el compás te lleva al alma! Igual que vos, ${userName}, puro ritmo.",
    },
    {
      setup: "¿Qué le dice un argentino al que no toma vino?",
      punchline:
        '¡“Estás seco, che, hidratate con clase!” Vos sos más copad${userName === "Miguel" ? "o" : "a"}, ${userName}.',
    },
    {
      setup: "¿Por qué el argentino no usa corbata?",
      punchline:
        "¡Porque el asado ya lo viste de gala! Como vos, ${userName}, puro estilo.",
    },
    {
      setup: "¿Qué hace un argentino con un mate lavado?",
      punchline:
        "¡Lo cambia más rápido que River en el descenso! Vos también zumbás, ${userName}.",
    },
    {
      setup: "¿Cómo sabe un argentino que el locro es bueno?",
      punchline:
        "¡Porque te calienta hasta el alma! Igual que vos, ${userName}, puro calor.",
    },
    {
      setup: "¿Qué le dice un rosarino al que no come pescado?",
      punchline:
        "¡“Estás negado pa’l Paraná, loco!” Vos sí que le das, ${userName}.",
    },
    {
      setup: "¿Por qué el argentino no se pierde en la Pampa?",
      punchline:
        "¡Porque el mate lo guía como faro! Como vos, ${userName}, puro rumbo.",
    },
    {
      setup: "¿Qué hace un argentino con una pizza sin oliva?",
      punchline:
        "¡Le pone más y la hace ratita blanca! Vos también le ponés chispa, ${userName}.",
    },
    {
      setup: "¿Cómo llama un argentino al que no baila chamamé?",
      punchline: "¡“Un palo del litoral, che!” Vos tenés flow, ${userName}.",
    },
    {
      setup: "¿Qué le dice un mendocino al vino tinto?",
      punchline:
        "¡“Ponete serio, loco, que esto es Mendoza!” Igual que vos, ${userName}, puro carácter.",
    },
    {
      setup: "¿Por qué el argentino no usa gorra en invierno?",
      punchline:
        "¡Porque el mate ya le calienta la cabeza! Como vos, ${userName}, puro calor.",
    },
    {
      setup: "¿Qué hace un argentino con una empanada sin carne?",
      punchline:
        "¡La rellena y la hace épica! Vos también tenés ese toque, ${userName}.",
    },
    {
      setup: "¿Cómo sabe un argentino que el partido es épico?",
      punchline:
        "¡Porque el grito cruza la Cordillera! Igual que vos, ${userName}, pura pasión.",
    },
    {
      setup: "¿Qué le dice un porteño al que no usa mate?",
      punchline:
        "¡“Estás seco, boludo, sumate a la ronda!” Vos sos más refrescante, ${userName}.",
    },
    {
      setup: "¿Por qué el argentino no le teme al frío patagónico?",
      punchline:
        "¡Porque el mate lo abriga como frazada! Como vos, ${userName}, puro calor.",
    },
    {
      setup: "¿Qué hace un argentino con un sánguche sin fiambre?",
      punchline:
        "¡Lo llena de milanesa y lo salva! Vos también improvisás, ${userName}.",
    },
    {
      setup: "¿Cómo llama un argentino al que no come fainá?",
      punchline:
        "¡“Un perdido en la pizzería, loco!” Vos sos de pura cepa, ${userName}.",
    },
    {
      setup: "¿Qué le dice un cordobés al fernet sin hielo?",
      punchline:
        "¡“Ponete las pilas, che, que esto es Córdoba!” Igual que vos, ${userName}, puro nervio.",
    },
    {
      setup: "¿Por qué el argentino no usa reloj en el asado?",
      punchline:
        "¡Porque el hambre marca el tiempo! Como vos, ${userName}, pura pasión.",
    },
    {
      setup: "¿Qué hace un argentino con un mate sin yerba?",
      punchline:
        "¡Lo llena al toque y no se raja! Vos también tenés actitud, ${userName}.",
    },
    {
      setup: "¿Cómo sabe un argentino que la birra es perfecta?",
      punchline:
        "¡Porque el frío le saca una sonrisa! Igual que vos, ${userName}, puro paladar.",
    },
    {
      setup: "¿Qué le dice un argentino al que no come choripán?",
      punchline:
        "¡“Estás negado pa’ lo nuestro, che!” Vos sí que le das, ${userName}.",
    },
    {
      setup: "¿Por qué el argentino no usa paraguas en verano?",
      punchline:
        "¡Porque la birra lo refresca desde adentro! Como vos, ${userName}, puro talento.",
    },
    {
      setup: "¿Qué hace un argentino con un locro frío?",
      punchline:
        "¡Lo calienta y lo hace rey otra vez! Vos también reciclás, ${userName}.",
    },
    {
      setup: "¿Cómo sabe un argentino que el tango es puro?",
      punchline:
        "¡Porque el bandoneón te lleva al barrio! Igual que vos, ${userName}, puro sentimiento.",
    },
    {
      setup: "¿Qué le dice un rosarino al que no toma liso?",
      punchline:
        '¡“Estás seco, loco, hidratate con onda!” Vos sos más copad${userName === "Miguel" ? "o" : "a"}, ${userName}.',
    },
    {
      setup: "¿Por qué el argentino no se pierde en la ciudad?",
      punchline:
        "¡Porque el mate lo guía como GPS! Como vos, ${userName}, puro rumbo.",
    },
    {
      setup: "¿Qué hace un argentino con una pizza sin muzzarella?",
      punchline:
    ...
    {
      setup: "¿Cómo llama un argentino al que no canta en la cancha?",
      punchline: "¡“Un mute en la popular, che!” Vos tenés voz, ${userName}.",
    },
    {
      setup: "¿Qué le dice un mendocino al vino caliente?",
      punchline:
        "¡“Enfriate, loco, que esto es serio!” Igual que vos, ${userName}, puro frío.",
    },
    {
      setup: "¿Por qué el argentino no usa botas en el campo?",
      punchline:
        "¡Porque las zapas son su orgullo! Como vos, ${userName}, puro estilo.",
    },
    {
      setup: "¿Qué hace un argentino con un mate sin bombilla?",
      punchline:
        "¡Lo toma con cucharita y sigue el vacile! Vos también tenés actitud, ${userName}.",
    },
    {
      setup: "¿Cómo sabe un argentino que el asado es épico?",
      punchline:
        "¡Porque el humo cruza el Río de la Plata! Igual que vos, ${userName}, pura pasión.",
    },
    {
      setup: "¿Qué le dice un porteño al que no usa subte?",
      punchline:
        "¡“Bajá, boludo, que no sos de Recoleta!” Vos tenés calle, ${userName}.",
    },
    {
      setup: "¿Por qué el argentino no le teme al invierno?",
      punchline:
        "¡Porque el mate lo calienta como estufa! Como vos, ${userName}, puro calor.",
    },
    {
      setup: "¿Qué hace un argentino con un sánguche sin milanesa?",
      punchline:
        "¡Lo rellena y lo hace rey! Vos también le ponés chispa, ${userName}.",
    },
    {
      setup: "¿Cómo llama un argentino al que no come empanadas?",
      punchline:
        "¡“Un perdido en la mesa, che!” Vos sos de pura cepa, ${userName}.",
    },
    {
      setup: "¿Qué le dice un cordobés al fernet sin soda?",
      punchline:
        "¡“Completate, loco, que esto es cuarteto!” Igual que vos, ${userName}, puro ritmo.",
    },
    {
      setup: "¿Por qué el argentino no usa reloj en la siesta?",
      punchline:
        "¡Porque el mate marca la hora! Como vos, ${userName}, pura onda.",
    },
    {
      setup: "¿Qué hace un argentino con un choripán sin salsa?",
      punchline:
        "¡Le pone chimichurri y lo hace épico! Vos también tenés sabor, ${userName}.",
    },
    {
      setup: "¿Cómo sabe un argentino que el partido es clásico?",
      punchline:
        "¡Porque el grito se escucha hasta el Obelisco! Igual que vos, ${userName}, pura pasión.",
    },
  ];
  ...
  try {
    ...
    let availableChistes = chistes.filter(
      (_, index) => !dataStore.usedJokes[userId].includes(index)
    );
    ...
    if (availableChistes.length === 0) {
      ...
      console.log(
        `Reiniciando chistes para ${userName} (${userId}), se agotaron los disponibles.`
      );
    }
    ...
    const embed = createEmbed(
      ...
      text: `Con cariño, Oliver IA | Reacciona con ✅ o ❌`,
...
async function manejarDato(message) {
  ...
  const waitingEmbed = createEmbed(
    "#FF1493",
    `⌛ Buscando, ${userName}...`,
    `Dame un segundo que te traigo algo copado${
      args ? ` sobre "${args}"` : ""
    }, loco...`
  );
  const waitingMessage = await message.channel.send({ embeds: [waitingEmbed] });
  ...
  const randomFacts = [
    {
      ...
      text:
        "Los gatos pueden saltar hasta 6 veces su longitud en un solo brinco. ¡Unos atletas felinos! Igual que vos, " +
        userName +
        ", siempre dando el salto zarpado, che.",
    },
    {
      title: "¡Abejas bailarinas!",
      text:
        "Las abejas hacen un baile en forma de 8 pa’ decirle a sus compañeras dónde está la comida. ¡Unas coreógrafas del aire! Vos también tenés ese ritmo, " +
        userName +
        ", pa’ romperla toda.",
    },
    {
      ...
      text:
        "Los elefantes nunca olvidan dónde dejaron el agua, incluso años después. ¡Una memoria bestial! Igual que vos, " +
        userName +
        ", que no te perdés ni un asado, loco.",
    },
    {
      title: "¡Canguros boxeadores!",
      text:
        "Los canguros macho se dan piñas pa’ impresionar a las hembras. ¡Unos campeones del ring! Vos, " +
        userName +
        ", también la rompés con estilo, che.",
    },
    {
      title: "¡Lobos cantores!",
      text:
        "Los lobos aúllan pa’ hablarse entre sí a kilómetros de distancia. ¡Unos rockeros de la naturaleza! Igual que vos, " +
        userName +
        ", siempre con voz fuerte, posta.",
    },
    {
      title: "¡Tiburones dormilones!",
      text:
        "Algunos tiburones duermen con los ojos abiertos y nadando pa’ no hundirse. ¡Unos genios multitasking! Como vos, " +
        userName +
        ", que hacés todo al toque.",
    },
    {
      title: "¡Ranas venenosas!",
      text:
        "La rana dardo venenoso tiene tanto veneno en su piel que puede matar a 10 personas con un toque. ¡Una mini asesina! Igual, " +
        userName +
        ", vos matás con tu onda.",
    },
    {
      title: "¡Camaleones artistas!",
      text:
        "Los camaleones cambian de color no solo pa’ camuflarse, sino también pa’ mostrar su humor. ¡Unos cracks expresivos! Vos, " +
        userName +
        ", también tenés ese flow, che.",
    },
    {
      title: "¡Delfines charlatanes!",
      text:
        "Los delfines tienen nombres propios que se silban entre ellos. ¡Unos capos de la comunicación! Igual que vos, " +
        userName +
    ...
    },
    {
      ...
      text:
        "Un murciélago puede comer hasta 1.000 mosquitos en una noche. ¡Un héroe nocturno! Vos, " +
        userName +
        ", también limpiás la cancha, loco.",
    },
    {
      title: "¡Arañas ingenieras!",
      text:
        "Las arañas tejen telas más fuertes que el acero, peso por peso. ¡Unas arquitectas zarpadas! Igual que vos, " +
        userName +
        ", siempre construyendo algo grosso.",
    },
    {
      title: "¡Koalas vagos!",
      text:
        "Los koalas duermen hasta 22 horas al día pa’ ahorrar energía. ¡Unos fiacas profesionales! Vos, " +
        userName +
        ", sos puro motor en comparación, che.",
    },
    {
      title: "¡Leones rugidores!",
      text:
        "El rugido de un león se escucha a 8 kilómetros de distancia. ¡Un parlante natural! Igual que vos, " +
        userName +
        ", que hacés temblar el barrio.",
    },
    {
      title: "¡Perezosos lentos!",
      text:
        "Un perezoso tarda un mes en digerir una hoja. ¡El rey de la pachorra! Vos, " +
        userName +
        ", zumbás mucho más rápido, loco.",
    },
    {
      title: "¡Avestruces velocistas!",
      text:
        "Un avestruz corre a 70 km/h, más rápido que un caballo. ¡Un bólido con plumas! Igual que vos, " +
        userName +
        ", siempre a full gas.",
    },
    {
      ...
      text:
        "Las ballenas jorobadas cantan canciones que duran horas y se copian entre ellas. ¡Unas rockstars del mar! Vos, " +
        userName +
        ", también tenés tu hit, che.",
    },
    {
      title: "¡Cocodrilos llorones!",
      text:
        "Los cocodrilos lloran mientras comen, pero no de tristeza, es pa’ lubricar los ojos. ¡Unos actores dramáticos! Igual que vos, " +
        userName +
        ", siempre con onda.",
    },
    {
      ...
      text:
        "Una hormiga puede cargar 50 veces su peso. ¡Una forzuda diminuta! Vos, " +
        userName +
        ", también levantás lo que sea, loco.",
    },
    {
      title: "¡Búhos giratorios!",
      text:
        "Los búhos pueden girar la cabeza 270 grados sin moverse. ¡Unos contorsionistas! Igual que vos, " +
        userName +
        ", siempre mirando pa’ todos lados.",
    },
    {
      title: "¡Pavos reales coquetos!",
      text:
        "El pavo real usa su cola pa’ conquistar, pero no vuela bien por el peso. ¡Un galán con estilo! Vos, " +
        userName +
        ", también tenés tu charme, che.",
    },
    {
      title: "¡Tortugas viajeras!",
      text:
        "Las tortugas marinas recorren miles de kilómetros pa’ volver a su playa natal. ¡Unas GPS vivientes! Igual que vos, " +
        userName +
        ", siempre encontrás el camino.",
    },
    {
      title: "¡Zorros astutos!",
      text:
        "Los zorros árticos cazan escuchando bajo la nieve y saltan pa’ atrapar presas. ¡Unos ninjas blancos! Vos, " +
        userName +
        ", también tenés ese olfato, loco.",
    },
    {
      title: "¡Flamencos equilibristas!",
      text:
        "Los flamencos duermen parados en una pata pa’ no gastar energía. ¡Unos cracks del balance! Igual que vos, " +
        userName +
        ", siempre firme.",
    },
    {
      ...
      text:
        "Las serpientes cambian de piel hasta 4 veces al año pa’ crecer. ¡Unas ratita blancas del makeover! Vos, " +
        userName +
        ", también te renovás siempre, che.",
    },
    {
      title: "¡Orcas estrategas!",
      text:
        "Las orcas cazan en equipo y usan olas pa’ tirar focas al agua. ¡Unas maestras del teamwork! Igual que vos, " +
        userName +
    ...
    },
    {
      ...
      text:
        "Los ciervos pierden y regeneran sus cuernos cada año. ¡Unos renovadores natos! Vos, " +
        userName +
        ", también volvés más fuerte, loco.",
    },
    {
      title: "¡Pandas glotones!",
      text:
        "Un panda come hasta 12 kilos de bambú al día pa’ sobrevivir. ¡Un campeón del morfi! Igual que vos, " +
        userName +
        ", con el asado.",
    },
    {
      ...
      text:
        "El halcón peregrino baja en picada a 300 km/h pa’ cazar. ¡Un misil con plumas! Vos, " +
        userName +
        ", también zumbás a mil, che.",
    },
    {
      title: "¡Medusas inmortales!",
      text:
        "La medusa *Turritopsis* puede volver a su estado juvenil después de vieja. ¡Una eterna joven! Igual que vos, " +
        userName +
        ", siempre con pilas.",
    },
    {
      ...
      text:
        "Los peces payaso viven entre anémonas venenosas pa’ protegerse. ¡Unos cracks del barrio! Vos, " +
        userName +
        ", también tenés tu lugar, loco.",
    },
    {
      title: "¡Cucarachas sobrevivientes!",
      text:
        "Una cucaracha puede vivir semanas sin cabeza hasta que se muere de hambre. ¡Unas duras posta! Igual que vos, " +
        userName +
        ", puro aguante.",
    },
    {
      ...
      text:
        "Los lémures de Madagascar se juntan en grupos pa’ cantar y bailar. ¡Unos locos del vacile! Vos, " +
        userName +
        ", también armás la joda, che.",
    },
    {
      title: "¡Pingüinos nadadores!",
      text:
        "Los pingüinos pueden nadar a 36 km/h pa’ escapar de depredadores. ¡Unos torpedos con smoking! Igual que vos, " +
        userName +
        ", siempre escapando con estilo.",
    },
    {
      title: "¡Jirafas altas!",
      text:
        "Las jirafas tienen el cuello más largo del reino animal, pero solo 7 vértebras como nosotros. ¡Unas cracks del estirón! Vos, " +
        userName +
        ", también destacás.",
    },
    {
      ...
      text:
        "Los osos polares hibernan hasta 8 meses sin comer ni moverse mucho. ¡Unos fiacas zarpados! Vos, " +
        userName +
        ", sos puro movimiento, loco.",
    },
    {
      title: "¡Gorilas fuertes!",
      text:
        "Un gorila puede levantar hasta 800 kilos con una mano. ¡Un tanque de la selva! Igual que vos, " +
        userName +
        ", siempre con fuerza, che.",
    },
    {
      title: "¡Chitas rápidas!",
      text:
        "El chita corre a 100 km/h en 3 segundos, pero solo por ratos cortos. ¡Un bólido felino! Vos, " +
        userName +
        ", también arrancás a mil.",
    },
    {
      title: "¡Buitres olfativos!",
      text:
        "Los buitres encuentran comida podrida oliendo a kilómetros. ¡Unos detectives del aire! Igual que vos, " +
        userName +
        ", siempre al tanto, loco.",
    },
    {
      title: "¡Peces voladores!",
      text:
        "Los peces voladores planean hasta 200 metros pa’ escapar de predadores. ¡Unos aviadores marinos! Vos, " +
        userName +
        ", también volás alto, che.",
    },
    {
      title: "¡Hipopótamos pesados!",
      text:
        "Un hipopótamo pesa hasta 4 toneladas y corre más rápido que un humano. ¡Un tanque con patas! Igual que vos, " +
        userName +
        ", puro poder.",
    },
    {
      ...
      text:
        "Los guacamayos usan sus plumas brillantes pa’ impresionar y comunicarse. ¡Unos artistas del aire! Vos, " +
        userName +
        ", también tenés tu brillo, loco.",
    },
    {
      title: "¡Rinocerontes blindados!",
      text:
        "La piel de un rinoceronte tiene 3 cm de grosor y lo hace casi impenetrable. ¡Un tanque natural! Igual que vos, " +
        userName +
        ", puro aguante.",
    },
    {
      title: "¡Cisnes fieles!",
      text:
        "Los cisnes se emparejan de por vida y defienden a su pareja a picotazos. ¡Unos románticos bravos! Vos, " +
        userName +
        ", también tenés ese corazón, che.",
    },
    {
      title: "¡Grillos cantores!",
      text:
        "Los grillos hacen música frotando sus alas pa’ atraer pareja. ¡Unos serenateros! Igual que vos, " +
        userName +
        ", siempre con onda.",
    },
    {
      ...
      text:
        "El armadillo de tres bandas se hace bolita pa’ protegerse. ¡Un ninja blindado! Vos, " +
        userName +
        ", también sabés defenderte, loco.",
    },
    {
      title: "¡Suricatas guardianas!",
      text:
        "Las suricatas tienen vigías que avisan al grupo si viene peligro. ¡Unas centinelas zarpadas! Igual que vos, " +
        userName +
        ", siempre alerta.",
    },
    {
      ...
      text:
        "Un tigre puede acechar en silencio y saltar 10 metros de una. ¡Un cazador ninja! Vos, " +
        userName +
        ", también tenés ese toque sigiloso, che.",
    },
    {
      title: "¡Caballitos de mar papás!",
      text:
        "Los caballitos de mar macho llevan los huevos en una bolsa hasta que nacen. ¡Unos padres copados! Igual que vos, " +
        userName +
        ", siempre bancando.",
    },
    {
      ...
      text:
        "El isópodo gigante del océano profundo mide hasta 50 cm y se enrolla como pelota. ¡Un tanque submarino! Vos, " +
        userName +
        ', también sos gros${userName === "Miguel" ? "o" : "a"}, loco.',
    },
    {
      title: "¡Águilas cazadoras!",
      text:
        "Un águila real puede ver un conejo a 3 kilómetros y bajar en picada a atraparlo. ¡Un sniper del cielo! Igual que vos, " +
        userName +
        ", siempre con visión zarpada.",
    },
  ];
  ...
  try {
    ...
    if (!args) {
      let availableFacts = randomFacts.filter(
        (fact) => fact.title !== ultimoDatoRandom?.title
      );
      ...
      embed = createEmbed(
        "#FF1493",
        `💡 ¡Dato copado pa’ ${userName}!`,
        "Che " +
          userName +
          ", ¡posta que sí, loco! Preparate porque esto te va a volar la cabeza:\n\n" +
          randomFact.text +
          "\n\n" +
          "¿Qué te parece, " +
          userName +
          "? Si querés más datos zarpados o algo específico, pedime nomás. ¡Sos tan gros" +
          (userName === "Miguel" ? "o" : "a") +
          " que cualquier curiosidad queda corta al lado tuyo, che!"
      ).setFooter({
        text: `Con cariño, Oliver IA | Reacciona con ✅ o ❌`,
        iconURL: client.user.avatarURL(),
      });
      ...
      if (!result || result.length === 0) {
        ...
        reply =
          result[0].snippet ||
          "No hay descripción, pero te lo resumo al toque.";
      }
    ...
    console.error(
      `Error buscando "${args || "dato random"}": ${error.message}`
    );
    const errorEmbed = createEmbed(
      "#FF1493",
      "¡Qué cagada!",
      `No pude encontrar nada${
        args ? ` sobre "${args}"` : ""
      }, ${userName}. ¿Probamos con otra cosa, loco?`
    );
    await waitingMessage.edit({ embeds: [errorEmbed] });
  }
}
...
async function manejarNoticias(message, silent = false) {
  ...
  const waitingEmbed = createEmbed(
    "#55FFFF",
    `📰 Buscando noticias, ${userName}...`,
    `Aguantá que te traigo lo último${
      isForTelegram
        ? userName === "Miguel"
          ? " de Ecuador"
          : " de Argentina"
  ...
  try {
    ...
    console.log(
      `Usando clave API: ${apiKey.substring(0, 4)}... (ocultada por seguridad)`
    );
    ...
    const fetchNews = async (country) => {
      ...
      try {
        ...
        console.log(
          `Respuesta cruda de ${country}: ${JSON.stringify(
            response.data,
            null,
            2
          )}`
        ...
        if (articles.length === 0) {
          ...
          console.log(
            `Sin noticias de hoy para ${country}, probando sin fecha: ${url}`
          );
        ...
        console.error(
          `Error al obtener noticias de ${country}: ${error.message}`
        );
        return [];
      }
    };
      ...
      noticias =
        relevantArticles.length > 0
          ? relevantArticles
              ...
              .map(
                (article, index) =>
                  `${index + 1}. ${article.title || "Sin título disponible"}`
              )
              .join("\n")
          : `No encontré noticias de ${
              userName === "Miguel" ? "Ecuador" : "Argentina"
            } hoy, loco.`;
    } else {
      const noticiasAR =
        articlesAR.length > 0
          ? articlesAR
              ...
              .map(
                (article, index) =>
                  `${index + 1}. **${
                    article.title || "Sin título disponible"
                  }**`
              )
              .join("\n")
    ...
    if (embedSize > 6000)
      throw new Error(
        `El embed excede el límite de 6000 caracteres: ${embedSize}`
      );
    ...
    if (!silent && !isForTelegram) {
      if (waitingMessage) {
        ...
        await message.channel.send({ embeds: [embed] });
        console.log(
          `Noticias enviadas directamente al canal de Discord para ${userName}`
        );
      }
    }
    return embed;
...
async function obtenerDatoInteresante(userName) {
  ...
  const availableFacts = randomFacts.filter(
    (fact) => fact.title !== ultimoDatoRandom?.title
  );
  const randomFact =
...
async function manejarWiki(message) {
  ...
  if (!args) {
    return sendError(
      message.channel,
      `¡Tirame algo después de "!wiki", ${userName}! Ejemplo: !wiki tango`
    );
  }

  const waitingEmbed = createEmbed(
    "#FF1493",
    `📖 Buscando en Wiki, ${userName}...`,
...
async function manejarTraduci(message) {
  ...
  if (args.length < 2) {
    return sendError(
      message.channel,
      `¡Escribí algo como "!traducí hola a inglés", ${userName}!`
    );
  }
  ...
  try {
    ...
    if (!langCode) {
      throw new Error(
        `No sé traducir a "${targetLang}", ${userName}. Probá con "inglés", "ruso", "francés", etc.`
      );
    }
    ...
    if (!translated || translated.toLowerCase() === text.toLowerCase()) {
      throw new Error(
        `¡Qué boludo! La traducción salió igual que el original: "${translated}". ¿La API está rota o qué?`
      );
    }
    ...
    console.error(
      `Error traduciendo "${text}" a "${targetLang}": ${error.message}`
    );
    if (error.response) {
      console.error(
        `Respuesta de la API: ${JSON.stringify(error.response.data)}`
      );
    }
    const errorEmbed = createEmbed(
      "#FF1493",
...
async function manejarWatchTogether(message) {
  ...
  try {
    ...
    const embed = createEmbed(
      "#FF1493",
      `🎥 ¡Watch Together, ${userName}!`,
      `¡Listo, ${
        userName === "Belen" ? "genia" : "genio"
      }! Hacé clic: [enlace](${inviteUrl})\n¡A romperla con videos, ${
        userName === "Belen" ? "loca" : "loco"
      }!`
    );
    await message.channel.send({ embeds: [embed] });
  } catch (error) {
...
async function manejarMilagros(message) {
  ...
  const translationsArray = Object.entries(milagrosTranslations).map(
    ([lang, translation]) =>
  ...
  for (const line of translationsArray) {
    ...
    if (newDescription.length > maxLength) {
      embeds.push(
        await createEmbed(
          "#FF1493",
          `Milagros en otros idiomas (Parte ${embeds.length + 1})`,
          description.trim()
        )
      );
      description = line + "\n";
  ...
  for (const embed of embeds) {
    try {
      ...
      await message.channel.send(
        "¡Uy, algo falló al mostrar las traducciones, loco!"
      );
    }
  }
}
...
manager.on("queueEnd", async (player) => {
  ...
  const userName =
    player.queue.current?.requester?.id === OWNER_ID ? "Miguel" : "Belén";

  console.log(
    `Cola terminó en guild ${guildId}. Autoplay: ${autoplay}, Tracks en cola: ${player.queue.size}`
  );

  if (autoplay && channel) {
    try {
      let trackIdentifier =
        player.queue.current?.identifier || player.queue.previous?.identifier;
      if (!trackIdentifier) {
      ...
      console.log(
        `Búsqueda relacionada: ${related.loadType}, tracks: ${related.tracks.length}`
      );
...
manager.on("trackStart", async (player, track) => {
  ...
  if (currentTrack === track.uri) {
    console.log(
      `Pista ${track.title} ya está en reproducción, ignorando trackStart. URI: ${track.uri}`
    );
    return;
  }
  console.log(
    `trackStart para ${track.title}, URI: ${track.uri}, seteando como pista actual.`
  );
  player.set("currentTrack", track.uri);
  player.set("trackEnded", false);

  console.log(
    `Iniciando pista: ${track.title} en guild ${player.guild}, queue.size=${player.queue.size}`
  );
  ...
  if (!thumbnail && track.uri && track.uri.includes("spotify")) {
    console.log(
      `Thumbnail no disponible, intentando con Spotify para ${track.uri}`
    );
  }
  ...
  if (!thumbnail) {
    ...
    console.log(
      `Sin thumbnail disponible para ${track.title}, usando placeholder.`
    );
  }
  ...
  const updateBossBar = () => {
    ...
    const positionFormatted = `${Math.floor(positionSeconds / 60)}:${(
      positionSeconds % 60
    )
      .toString()
      .padStart(2, "0")}`;
...
manager.on("trackEnd", (player, track) => {
  console.log(
    `trackEnd disparado para: ${track.title}, guild: ${player.guild}, queue.size: ${player.queue.size}, URI: ${track.uri}`
  );
  ...
  if (
    player.get("trackEnded") ||
    (currentTrackUri && currentTrackUri !== track.uri)
  ) {
    console.log(
      `Ignorando trackEnd para ${track.title}. Ya terminó o no es la pista actual (current: ${currentTrackUri}).`
    );
    return;
  }
  console.log(
    `Procesando trackEnd para ${track.title}, marcando como terminado.`
  );
  player.set("trackEnded", true);

  // Actualizamos el embed al 100%
  if (progressMessage && track) {
    const durationStr = `${Math.floor(track.duration / 60000)}:${(
      (track.duration % 60000) /
      1000
    )
      .toFixed(0)
    ...
    const finalEmbed = createEmbed(
      ...
      .addFields(
        ...
        {
          name: "📊 Progreso",
          value: `${bossBar} ${durationStr} / ${durationStr}`,
          inline: true,
        }
      )
      .setThumbnail(
        track.thumbnail || "https://i.imgur.com/defaultThumbnail.png"
      )
      .setFooter({
        text: `Oliver IA - Música con onda | Pedido por ${userName}`,
        iconURL: client.user.avatarURL(),
      })
      .setTimestamp();
    ...
    progressMessage
      ...
      .catch((err) => console.error("Error editando embed final:", err));
  }
  ...
  dataStore.musicSessions[guildId].history =
    dataStore.musicSessions[guildId].history || [];
  if (track) {
...
async function manejarCommand(message, silent = false) {
  ...
  if (content === "!trivia cancelar" || content === "!tc") {
    if (message.author.id !== OWNER_ID && message.author.id !== ALLOWED_USER_ID)
      return;

    const channelProgress =
      dataStore.activeSessions[`trivia_${message.channel.id}`];
    if (!channelProgress || channelProgress.type !== "trivia") {
      await sendError(
        message.channel,
        `No hay ninguna trivia activa para cancelar, ${userName}.`,
    ...
    if (!session || session.type !== "reaction" || session.completed) {
      await sendError(
        message.channel,
        `No hay un juego de reacciones activo para cancelar, ${userName}.`,
    ...
    await sendSuccess(
      message.channel,
      "🛑 ¡Juego de reacciones cancelado!",
      `Listo, ${userName}, cortaste el juego al toque. Puntuación parcial: ${
        session.score
      } en ${
        session.currentRound - 1
      } rondas. ¿Arrancamos otro con !reacciones?`
    );
    return;
    ...
    await new Promise((resolve) => setTimeout(resolve, 1000));
    await message.channel.send(
      "¡Nah, era joda! Acá sigo, más vivo que nunca. 😜"
    );
    return;
    ...
    try {
      ...
      const response = await axios.get(
        `https://api.giphy.com/v1/gifs/random?api_key=${API_KEY}&tag=meme+español&rating=pg-13`
      );
      ...
      const pregunta =
        preguntasMeme[Math.floor(Math.random() * preguntasMeme.length)];
      const preguntaEmbed = createEmbed(
        "#FF1493",
        `¡Eh, ${userName}, una yapa!`,
    ...
    content.startsWith("!recordatorio") ||
    content.startsWith("!rec")
  ) {
    await manejarRecordatorio(message);
  } else if (content === "!misrecordatorios" || content === "!mr") {
    await manejarMisRecordatorios(message);
  } else if (
    content.startsWith("!cancelarrecordatorio") ||
    content.startsWith("!cr")
  ) {
    ...
    const mensaje =
      mensajesAnimo[Math.floor(Math.random() * mensajesAnimo.length)];
    ...
    const args = message.content
      .slice(content.startsWith("!play") ? 5 : 3)
      .trim()
      .split(/ +/);
...
client.on("messageCreate", async (message) => {
  ...
  if (hasJefeMention || hasJefaMention) {
    ...
    const canalRecordatorios = client.channels.cache.get(
      targetName === "Miguel" ? canalMiguel : canalBelen
    );

    if (!canalGeneral || !canalRecordatorios) {
      console.error(
        `No se encontró el canal general (ID: ${canalGeneralId}) o el canal de recordatorios (ID: ${
          targetName === "Miguel" ? canalMiguel : canalBelen
        })`
      );
      return;
    ...
    const processEvent = async (isArrival) => {
      console.log(
        `Procesando ${isArrival ? "llegada" : "salida"} de ${targetName}`
      );
      try {
      ...
      const recordatoriosUsuario = dataStore.recordatorios.filter(
        (r) => r.userId === userId
      );
        ...
        recordatoriosUsuario.forEach((r, index) => {
          if (!r.esRecurrente && r.timestamp) {
            ...
            const diaRecordatorio = new Date(
              fechaRecordatorio.getFullYear(),
              fechaRecordatorio.getMonth(),
              fechaRecordatorio.getDate()
            );
            if (diaRecordatorio.getTime() === hoy.getTime()) {
              ...
              const fechaHoraDiscord = fechaRecordatorio
                .toLocaleString(targetName === "Miguel" ? "es-EC" : "es-AR", {
                  timeZone,
                  day: "2-digit",
                  month: "2-digit",
                  year: "numeric",
                ...
                .replace(/,/, "");
              recordatoriosDiscord.push(
                `${index + 1}. ${r.mensaje}\nCuándo: ${fechaHoraDiscord}`
              );
              const horaTelegram = fechaRecordatorio
                .toLocaleTimeString(
                  targetName === "Miguel" ? "es-EC" : "es-AR",
                  {
                    timeZone,
                    hour: "2-digit",
                    minute: "2-digit",
                ...
                .toLowerCase();
              recordatoriosTelegram.push(
                `- ${r.mensaje} (para ${horaTelegram})`
              );
            }
          }
        });
      ...
      try {
        const climaResult = await manejarCommand(
          {
            content:
              targetName === "Belén" ? "!clima San Luis" : "!clima Guayaquil",
      ...
      try {
        ...
        if (noticiasResult?.description) {
          noticias = noticiasResult.description
            .split("\n")
            .slice(0, 3)
            .join("\n");
        }
      ...
      try {
        ...
        console.log(
          `Dato interesante obtenido para ${targetName}: ${datoInteresante}`
        );
      } catch (error) {
      ...
      const consejoClima = generarConsejoClima(
        clima || "Desconocido",
        !isArrival
      );
      const consejoHora = generarConsejoHora(horaLocal || "00:00");
      const totalRecordatorios = recordatoriosUsuario.length;
      const resumenRecordatorios =
        totalRecordatorios > 0
          ? `Tenés ${totalRecordatorios} recordatorios en total.`
          : "No tenés recordatorios, ¡a descansar tranqui!";

      const embed = createEmbed(
        "#FF1493",
        isArrival
          ? `¡Bienvenid@ a casa, ${targetName}! 🏠`
          : `¡A la calle, ${targetName}! 🚪`,
        isArrival
          ? `¡Qué lindo tenerte de vuelta, ${
              targetName === "Miguel" ? "capo" : "genia"
            }!`
          : `¡${
              targetName === "Miguel" ? "Grande, capo" : "Ey, genia"
            }! Saliste a romperla toda, ¿no?`
      )
        .addFields(
          {
            name: `🌤️ Clima en ${
              targetName === "Belén" ? "Argentina" : "Ecuador"
            }`,
            value: isArrival ? clima : `${clima}\n${consejoClima}`,
            inline: false,
          },
          {
            name: `⏰ Hora en ${
            ...
            value: isArrival ? horaLocal : `${horaLocal}\n${consejoHora}`,
            inline: true,
          },
          {
            name: "📅 Recordatorios",
            value:
              recordatoriosDiscord.length > 0
                ? recordatoriosDiscord.slice(0, 2).join("\n")
          ...
          },
          {
            name: "📰 Noticias",
            value:
              noticias.length > 1024
                ? noticias.substring(0, 1021) + "..."
                : noticias,
            inline: false,
          },
          {
            name: "💡 Dato interesante",
            value:
              datoInteresante.length > 1024
                ? datoInteresante.substring(0, 1021) + "..."
                : datoInteresante,
            inline: false,
          },
      ...
      try {
        ...
        console.log(
          `Embed enviado al canal general ${canalGeneralId} para ${
      ...
      const mensajeTelegram = isArrival
        ? `¡${
            targetName === "Miguel" ? "Grande, Miguel" : "Ey, Belén"
          }! Bienvenid@ a casa, ${
            targetName === "Miguel" ? "capo" : "genia"
          }. 🏠\n` +
          `Clima en ${
          ...
          `Recordatorios: ${
            recordatoriosTelegram.length > 0
              ? recordatoriosTelegram.slice(0, 2).join("\n")
              : "Ninguno para hoy"
          }\n` +
          `Noticias:\n${noticias}\n` +
      ...
      try {
        ...
        console.log(
          `Mensaje enviado a Telegram para ${targetName} (chat_id: ${chatId})`
        );
      } catch (error) {
  ...
  if (
    lettersOnly.length > 80000000 &&
    (message.author.id === OWNER_ID || message.author.id === ALLOWED_USER_ID)
  ) {
      ...
      try {
        ...
        if (
          ...
          await member.timeout(
            5 * 60 * 1000,
            "Te pasaste con las mayúsculas, loco"
          );
          await message.channel.send({
            embeds: [
              createEmbed(
  ...
  if (content === "!tc" || content === "!trivia cancelar") {
    ...
    if (!session || session.type !== "trivia") {
      await sendError(
        message.channel,
        `No hay trivia activa, ${userName}.`,
        "¿Querés una con !trivia?"
      );
    } else {
      session.active = false;
      delete dataStore.activeSessions[triviaKey];
      ...
      await sendSuccess(
        message.channel,
        "🛑 ¡Trivia cancelada!",
        `Listo, ${userName}. Puntuación: ${session.score}/${session.currentQuestion}.`
      );
    }
    return;
  }
  ...
  if (content === "!rc" || content === "!reacciones cancelar") {
    ...
    if (!session || session.type !== "reaction" || session.completed) {
      await sendError(
        message.channel,
        `No hay reacciones activas, ${userName}.`,
        "¿Arrancamos con !reacciones?"
      );
    } else {
      session.active = false;
      session.completed = true;
      ...
      await sendSuccess(
        message.channel,
        "🛑 ¡Reacciones canceladas!",
        `Listo, ${userName}. Puntuación: ${session.score}.`
      );
    }
    return;
  }
  ...
  if (content === "!ranking" || content === "!rk") {
    const embed = getCombinedRankingEmbed(
      message.author.id,
    ...
    const embed = createEmbed(
      "#FF1493",
      `¡Comandos de música para vos, ${userName}!`,
...
client.once("ready", async () => {
  console.log(
    `¡Oliver IA está listo! Instancia: ${instanceId} - ${new Date().toLocaleString(
      "es-AR",
      { timeZone: "America/Argentina/Buenos_Aires" }
    )}`
  );
  client.user.setPresence({
    activities: [{ name: "Listo para ayudar a Milagros", type: 0 }],
    status: "idle",
  });
  ...
  if (dataStore.recordatorios && dataStore.recordatorios.length > 0) {
    ...
    dataStore.recordatorios.forEach((recordatorio) => {
      if (
        recordatorio.timestamp &&
        (recordatorio.timestamp > ahoraUTC || recordatorio.esRecurrente)
      ) {
        console.log(
          `Restaurando recordatorio: "${recordatorio.mensaje}" (ID: ${recordatorio.id})`
        );
        if (recordatorio.esRecurrente) {
          const proximo = new Date(ahoraArgentina);
          proximo.setHours(recordatorio.hora, recordatorio.minutos, 0, 0);
        ...
        console.log(
          `Manteniendo recordatorio sin timestamp: "${recordatorio.mensaje}" (ID: ${recordatorio.id})`
        );
      }
    });
    dataStore.recordatorios = dataStore.recordatorios.filter(
  ...
  activeTrivia = new Map(
    Object.entries(dataStore.activeSessions).filter(
      ([_, s]) => s.type === "trivia"
    )
  );
  ...
  try {
    ...
    if (!dataStore.relationshipMessageId) {
      ...
      const relationshipEmbed = createEmbed(
        "#FF1493",
        "💔 Milagros, hablemos de lo nuestro",
      ...
      try {
        ...
        autoModified = true;
        console.log(
          "Mensaje de relación no encontrado, nuevo mensaje enviado con ID:",
          message.id
        );
      }
    }
    ...
    const historySummary =
      userHistory.length > 0
        ? userHistory
            .slice(-3)
            .map(
              (msg) => `${msg.role === "user" ? "Luz" : "Yo"}: ${msg.content}`
            )
            .join("\n")
    ...
    const updatesChanged =
      JSON.stringify(BOT_UPDATES) !== JSON.stringify(dataStore.sentUpdates);

    if (updatesChanged) {
      const updateEmbed = createEmbed(
        "#FF1493",
        "📢 Actualizaciones de Oliver IA",
      ...
      console.log(
        "No hay cambios en BOT_UPDATES respecto a sentUpdates, no se envían."
      );
    }
    ...
    const lastSentUtil =
      dataStore.utilMessageTimestamps[`util_${CHANNEL_ID}`] || 0;
    const lastSentReminder =
      dataStore.utilMessageTimestamps[`reminder_${CHANNEL_ID}`] || 0;
    ...
    setInterval(async () => {
      ...
      if (
        previousDataStore !== null &&
        currentDataStoreString === previousDataStore
      ) {
      ...
      setTimeout(async () => {
        ...
        if (
          previousDataStore !== null &&
          finalDataStoreString === previousDataStore
        ) {
          console.log(
            "No hay cambios reales en el timeout, omitiendo guardado"
          );
          userModified = false;
          autoModified = false;
          return;
            ...
            await channel.send({
              embeds: [
                createEmbed(
                  "#FF1493",
                  "¡Qué cagada!",
                  "No pude guardar los datos en GitHub, loco. Error: " +
                    error.message
                ),
              ],
            });
    ...
    setInterval(async () => {
      ...
      const recordatoriosPendientes = dataStore.recordatorios.filter(
        (r) => r.cuandoLlegue && r.timestamp && ahora >= r.timestamp
      );
        ...
        await channel.send({
          embeds: [
            createEmbed(
              "#FF1493",
              "⏰ ¡Ojo, loco/a!",
              `Che, ${userName}, te iba a avisar "${
                r.mensaje
              }" al llegar a casa a las ${new Date(
                r.timestamp
              ).toLocaleTimeString(
                "es-AR"
              )}, pero no sé si llegaste. ¿Estás en casa ya?`
            ),
          ],
        });
        dataStore.recordatorios = dataStore.recordatorios.filter(
    ...
    console.error(
      "Error al enviar actualizaciones o configurar el bot:",
      error.message
    );
  }
});
...
client.on("interactionCreate", async (interaction) => {
  ...
  if (interaction.user.id !== ALLOWED_USER_ID) {
    await interaction.reply({
      content: "¡Opa, este mensaje no es para vos!",
      ephemeral: true,
    });
    return;
  }
  ...
  if (interaction.customId === "care_relationship") {
    await interaction.update({
      embeds: [
        createEmbed(
          "#FF1493",
          "💖 Milagros, gracias por darme una chance",
    ...
    await interaction.update({
      embeds: [
        createEmbed(
          "#FF1493",
          "💔 Milagros, respeto lo que sentís",
        ...
        await channel.send({
          embeds: [
            createEmbed(
              "#FF1493",
              "👋 Adiós...",
              `<@${YOUR_USER_ID}> fue expulsado del servidor como pidió. Gracias por todo, Milagros. Me desconecto.`
            ),
          ],
          components: [],
        });
        ...
        await channel.send({
          embeds: [
            createEmbed(
              "#FF1493",
              "❌ Error",
              `No pude expulsar a <@${YOUR_USER_ID}>, no lo encuentro en el servidor. Me desconecto igual.`
            ),
          ],
          components: [],
        });
      ...
      await channel.send({
        embeds: [
          createEmbed(
            "#FF1493",
            "❌ Error",
            `No pude expulsar a <@${YOUR_USER_ID}> por un error: ${error.message}. Me desconecto igual.`
          ),
        ],
        components: [],
      });
